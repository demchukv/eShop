...
class ZoneController extends Controller
{
    ...
    {
        return view('admin.pages.forms.zones');
    }
    ...
    public function list(Request $request)
    {
        ...
        $zones = $zones->map(function ($z) {
            ...
            $z->serviceable_cities = $this->get_cities_by_ids($z->serviceable_city_ids);
    ...
    public function get_cities_by_ids($city_ids)
    {
        $ids_array = explode(',', $city_ids);
        $cities = City::whereIn('id', $ids_array)->get();
        $cities_array = $cities->pluck('name')->toArray();
        $comma_seprated_cities = implode(',', $cities_array);
    ...
    public function edit($id)
    {
        ...
        return view('admin.pages.forms.update_zone', compact('zone', 'zipcodes', 'cities', 'all_zipcodes', 'all_cities'));
    }
    ...
    public function update(Request $request, $id)
    {
        ...
        $data['name'] = $request->name ?? $zone_data->name;

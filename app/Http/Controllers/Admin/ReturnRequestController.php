...
class ReturnRequestController extends Controller
{
    ...
    public function list()
    {
        ...
        $search_res->orderBy($sort, $order)
            ->select('rr.id', 'rr.remarks', 'oi.order_id', 'u.id as user_id', 'u.username as username', 'p.name as product_name', 'oi.price', 'oi.delivery_boy_id', 'oi.discounted_price', 'oi.id as order_item_id', 'oi.quantity', 'oi.sub_total', 'rr.status', 's.name as store_name')
            ->skip($offset)
            ->take($limit);

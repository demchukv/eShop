...
class ComboProductController extends Controller
{
    public function index()
    {
        ...
        return view('admin.pages.forms.combo_products', compact('attributes', 'sellers', 'product_deliverability_type'));
    }
    ...
    public function edit($data)
    {
        ...
        if ($data === null || empty($data)) {
            ...
            return view('admin.pages.forms.update_combo_product', compact('data', 'attributes', 'sellers', 'shipping_data', 'product_details', 'combo_product_details', 'product_deliverability_type'));
        }
    }
    ...
    public function show($id)
    {
        ...
        if ($data === null || empty($data)) {
            ...
            return view('admin.pages.views.combo_product', compact('data', 'attributes', 'sellers', 'taxes',  'shipping_data', 'product_faqs', 'product_details', 'combo_product_details', 'rating'));
        }
    }

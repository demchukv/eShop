        ...
        foreach ($city_search_res as $row) {
            ...
            if ($row->send_to == 'all_users' || in_array($user_id, $row->users_id)) {
                ...
                $tempRow = [
                    ...
                    'image' => '<div class="d-flex justify-content-around"><a href="' . asset('/storage/' . $row->image) . '" data-lightbox="banner-' . $row->id . '"><img src="' .  $row->image . '" alt="Avatar" class="rounded table-image"/></a></div>',
                    'link' => $row->link,

...
class SellerController extends Controller
{
    ...
    {
        // dD($request->file('other_documents'));
    ...
    public function edit($id)
    {
        ...
        $store_data = DB::table('seller_store')
            ...
            ->select('seller_store.*', 'seller_data.authorized_signature', 'seller_data.status as seller_status', 'seller_data.national_identity_card', 'seller_store.address_proof', 'seller_data.pan_number')
        ...
        if ($store_data->isEmpty()) {
            ...
            return view('admin.pages.forms.update_seller', compact('seller_data', 'categories', 'store_data', 'store_id', 'zipcodes', 'cities', 'note_for_necessary_documents'));
        }
    }
        ...
        if (!$seller_data) {
            ...
            if ($request->store_status !== null) {
                if ($seller_store_detail[0] != $request->store_status) {
                    ...
                    $store_name = fetchDetails('stores', ['id' => 1], 'name');

...
class TaxController extends Controller
{
    ...
    {
        return view('admin.pages.forms.taxes');
    }

    public function store(Request $request)
    {
        $validator = Validator::make($request->all(), [
            'title' => 'required|unique:taxes,title', // Add unique validation rule
        ...
        $validatedData['percentage'] = $request->percentage;
    ...
    public function destroy($id)
    {
        ...
        if (isForeignKeyInUse('products', 'tax', $id)) {
            ...
            if ($tax->delete()) {
                return response()->json([
                    'error' => false, 'message' => labels('admin_labels.tax_deleted_successfully', 'Tax deleted successfully!')
                ]);
            } else {
    ...
    public function update(Request $request, $id)
    {
        ...
        if (!$tax) {
            ...
            $validator = Validator::make($request->all(), [
                'edit_title' => 'required|unique:taxes,title,' . $id, // Add unique validation rule with ID of current tax record

...
class LanguageController extends Controller
{
    public function index()
    {
        ...
        return view('admin.pages.forms.language', compact('languages', 'current_language_code', 'current_language'));
    ...
    public function delete($id)
    {
        ...
        if ($language) {
            return response()->json(['error' => false, 'message' => labels('admin_labels.language_deleted_successfully', 'Language Deleted Successfully')]);
        } else {
            return response()->json(['error' => false, 'message' => labels('admin_labels.error_occurred_while_deleting_language', 'Error occurred while deleting language')]);
        }
    }

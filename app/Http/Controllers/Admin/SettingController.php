...
class SettingController extends Controller
{
    ...
    public function storeSystemSetting(Request $request)
    {
        ...
        $data = [
            ...
            'value' => json_encode([
                ...
                'tg_bot_user_name' => $request->tg_bot_user_name,
                'tg_bot_token' => $request->tg_bot_token,
    ...
    public function storePaymentSetting(Request $request)
    {
        ...
        if ($request->midtrans_method == '1') {
            $validator = Validator::make($request->all(), [
                'midtrans_payment_mode' => 'required',
        ...
        if ($request->flutterwave_method == '1') {
            $validator = Validator::make($request->all(), [
                'flutterwave_public_key' => 'required',
                'flutterwave_secret_key' => 'required',
                'flutterwave_encryption_key' => 'required',
                'flutterwave_currency_code' => 'required',
                'flutterwave_webhook_secret_key' => 'required',
            ]);
            if ($validator && $validator->fails()) {
                $errors = $validator->errors();
        ...
        if ($request->fatoorah_method == '1') {
            $validator = Validator::make($request->all(), [
                'myfatoorah_token' => 'required',
                'myfatoorah_payment_mode' => 'required',
                'myfatoorah_language' => 'required',
                'myfatoorah__webhook_url' => 'required',
                'myfatoorah_country' => 'required',
                'myfatoorah__secret_key' => 'required',
            ]);
            if ($validator && $validator->fails()) {
                $errors = $validator->errors();
        ...
        // Check if $validator is not null and then validate
        if ($validator && $validator->fails()) {
            $errors = $validator->errors();
        ...
        $data = [
            ...
            'value' => json_encode([
                ...
                'midtrans_method' => isset($request->midtrans_method) && $request->midtrans_method == "1" ? 1 : 0,
                'midtrans_payment_mode' => $request->midtrans_payment_mode,
                ...
                'flutterwave_method' => isset($request->flutterwave_method) && $request->flutterwave_method == "1" ? 1 : 0,
                'flutterwave_public_key' => $request->flutterwave_public_key,
                'flutterwave_secret_key' => $request->flutterwave_secret_key,
                'flutterwave_encryption_key' => $request->flutterwave_encryption_key,
                'flutterwave_currency_code' => $request->flutterwave_currency_code,
                'flutterwave_webhook_secret_key' => $request->flutterwave_webhook_secret_key,
                'fatoorah_method' => isset($request->fatoorah_method) && $request->fatoorah_method == "1" ? 1 : 0,
                'myfatoorah_token' => $request->myfatoorah_token,
                'myfatoorah_payment_mode' => $request->myfatoorah_payment_mode,
                'myfatoorah_language' => $request->myfatoorah_language,
                'myfatoorah__webhook_url' => $request->myfatoorah__webhook_url,
                'myfatoorah_country' => $request->myfatoorah_country,
                'myfatoorah__successUrl' => $request->myfatoorah__successUrl,
                'myfatoorah__errorUrl' => $request->myfatoorah__errorUrl,
                'myfatoorah__secret_key' => $request->myfatoorah__secret_key,
    ...
    public function storeNotificationSettings(Request $request)
    {
        ...
        DB::table('settings')->updateOrInsert(
            ...
            ['value' => $data['firebase_project_id'], 'updated_at' => now()]
        );
    ...
    public function storeWebSettings(Request $request)
    {
        ...
        if ($request->app_download_section === 'on') {
            $validator->sometimes('app_download_section_title', 'required|string', function ($input) {
                return true;
            });
            $validator->sometimes('app_download_section_tagline', 'required|string', function ($input) {
                return true;
            });
            $validator->sometimes('app_download_section_short_description', 'required|string', function ($input) {
                return true;
            });
            $validator->sometimes('app_download_section_playstore_url', 'required', function ($input) {
                return true;
            });
            $validator->sometimes('app_download_section_appstore_url', 'required', function ($input) {
                return true;
            });
        }
        ...
        if ($request->shipping_mode === 'on') {
            ...
            $validator->sometimes('shipping_title', 'required|string', function ($input) {
                return true;
            });
            $validator->sometimes('shipping_description', 'required|string', function ($input) {
                return true;
            });
        }
        if ($request->return_mode === 'on') {

            $validator->sometimes('return_title', 'required|string', function ($input) {
                return true;
            });
            $validator->sometimes('return_description', 'required|string', function ($input) {
                return true;
            });
        }
        if ($request->support_mode === 'on') {

            $validator->sometimes('support_title', 'required|string', function ($input) {
                return true;
            });
            $validator->sometimes('support_title', 'required|string', function ($input) {
                return true;
        ...
        if ($request->safety_security_mode === 'on') {
            $validator->sometimes('safety_security_title', 'required|string', function ($input) {
                return true;
            });
        }
        if ($validator->fails()) {

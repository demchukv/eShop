...
class HomeController extends Controller
{
    ...
    public function index()
    {
        ...
        $monthlyTopSellingCategoriesData['categoryNames'] = $topSellingCategoriesDataMonthRes->pluck('category_name');
        ...
        $weeklyTopSellingCategoriesData['categoryNames'] = $topSellingCategoriesDataWeekRes->pluck('category_name');
        ...
        $categories = Category::select('id', 'name')
            ...
            ->where('store_id', $store_id)
            ->get();
        return view('seller.pages.forms.home', compact('store_id', 'seller_id', 'id', 'messengerColor', 'dark_mode', 'role_id', 'currency', 'total_balance', 'overallSale', 'latestRatings', 'sales', 'topSellingCategories', 'seller_rating', 'store_rating', 'categories'));
    }
    ...
    public function topSellingProducts(Request $request)
    {
        ...
        $query = DB::table('order_items')
            ->join('product_variants', 'order_items.product_variant_id', '=', 'product_variants.id')
            ->join('products', 'product_variants.product_id', '=', 'products.id')
            ->select('products.image as product_image', 'products.name', DB::raw('SUM(order_items.quantity) as total_sold'))
            ->where('order_items.seller_id', '=', $seller_id)
            ->where('order_items.store_id', '=', $store_id);
    ...
    public function mostPopularProduct(Request $request)
    {
        ...
        // Add common conditions for seller_id and store_id
        $topRatedProducts->where('order_items.seller_id', '=', $seller_id)
            ->where('order_items.store_id', '=', $store_id)

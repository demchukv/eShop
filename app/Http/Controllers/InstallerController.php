...
class InstallerController extends Controller
{
    ...
    public function install(Request $request)
    {
        ...
        if (file_exists($sqlDumpPath)) {
            ...
            //     return response()->json(['error' => true, 'message' => 'Connection OK']);
            // } catch (\Exception $e) {
            //     return response()->json(['error' => true, 'message' => "Could not connect to the database.  Please check your configuration. error:" . $e]);
            // }
            // Clear the database

        ...
        <div class="row">
            <div class="d-flex row align-items-center">
                <div class="col-md-6 page-info-title">
                    <h3>{{ labels('admin_labels.sales_report', 'Sales Report') }}</h3>
                    <p class="sub_title">
                        {{ labels('admin_labels.empower_seller_with_comprehrnsive_and_actionable_sales_insight', 'Empower Sellers with Comprehensive and Actionable Sales Insights') }}
                    </p>
                </div>
                <div class="col-md-6 d-flex justify-content-end">
                    <nav aria-label="breadcrumb" class="float-end">
                        <ol class="breadcrumb">
                            ...
                            <li class="breadcrumb-item">{{ labels('admin_labels.reports', 'Reports') }}</li>
                            <li class="breadcrumb-item active" aria-current="page">
                                {{ labels('admin_labels.sales_report', 'Sales Report') }}</li>
                        </ol>
                    </nav>
                </div>
            </div>
                                ...
                                <div class="col-md-12 col-xxl-6 d-flex justify-content-end ">
                                    ...
                                    <div class="dropdown">
                                        ...
                                        <ul class="dropdown-menu" aria-labelledby="exportOptionsDropdown">
                                            <li><button class="dropdown-item" type="button" onclick="exportTableData('seller_sales_report_table','csv')">CSV</button></li>
                                            <li><button class="dropdown-item" type="button" onclick="exportTableData('seller_sales_report_table','json')">JSON</button></li>
                                            <li><button class="dropdown-item" type="button" onclick="exportTableData('seller_sales_report_table','sql')">SQL</button></li>
                                            <li><button class="dropdown-item" type="button" onclick="exportTableData('seller_sales_report_table','excel')">Excel</button></li>
                                        </ul>
                                    </div>
                                </div>
                            </div>

        ...
        <div class="row">
            <div class="d-flex row align-items-center">
                <div class="col-md-6 page-info-title">
                    <h3>{{ labels('admin_labels.manage_orders', 'Order Manage') }}</h3>
                    <p class="sub_title">
                        {{ labels('admin_labels.all_information_about_orders', 'All Information About Orders') }}</p>
                </div>
                <div class="col-md-6 d-flex justify-content-end">
                    <nav aria-label="breadcrumb" class="float-end">
                        <ol class="breadcrumb">
                            ...
                            <li class="breadcrumb-item">{{ labels('admin_labels.manage_orders', 'Order Manage') }}</li>
                            <li class="breadcrumb-item active" aria-current="page">
                                {{ labels('admin_labels.orders', 'Orders') }}</li>
                        </ol>
                    </nav>
                </div>
            </div>
                            ...
                            <div class="col-md-12 col-lg-6 d-flex justify-content-end">
                                ...
                                <div class="dropdown">
                                    ...
                                    <ul class="dropdown-menu" aria-labelledby="exportOptionsDropdown">
                                        <li><button class="dropdown-item" type="button" onclick="exportTableData('seller_order_item_table','csv')">CSV</button></li>
                                        <li><button class="dropdown-item" type="button" onclick="exportTableData('seller_order_item_table','json')">JSON</button></li>
                                        <li><button class="dropdown-item" type="button" onclick="exportTableData('seller_order_item_table','sql')">SQL</button></li>
                                        <li><button class="dropdown-item" type="button" onclick="exportTableData('seller_order_item_table','excel')">Excel</button></li>
                                    </ul>
                                </div>
                            </div>
                        </div>

                    ...
                    <div class="col-xxl-4 col-lg-4 col-md-6 col-sm-12 col mb-6">
                        <div class="info-box align-items-center">
                            ...
                            <div class="content">
                                ...
                                <h5>{{ returnRequestsCount(0, $seller_id) }}</h5>
                            </div>
                        </div>
                    </div>
                    <div class="col-xxl-4 col-lg-4 col-md-6 col-sm-12 col mb-6">
                        <div class="info-box align-items-center">
                            ...
                            <div class="content">
                                ...
                                <h5>{{ returnRequestsCount(1, $seller_id) }}</h5>
                            </div>
                        </div>
                    </div>
                    <div class="col-xxl-4 col-lg-4 col-md-6 col-sm-12 col mb-6">
                        <div class="info-box align-items-center">
                            ...
                            <div class="content">
                                ...
                                <h5>{{ returnRequestsCount(2, $seller_id) }}</h5>
                            </div>
                        </div>
                    </div>
                </div>
                        ...
                        <div class="row">
                            ...
                            <div class="col-md-12 col-lg-6 d-flex justify-content-end">
                                <div class="input-group me-2 search-input-grp">
                                    ...
                                    <input type="text" data-table="seller_return_request_table"
                                ...
                                <div class="dropdown">
                                    ...
                                    <ul class="dropdown-menu" aria-labelledby="exportOptionsDropdown">
                                        <li><button class="dropdown-item" type="button"
                                                onclick="exportTableData('seller_return_request_table','csv')">CSV</button>
                                        </li>
                                        <li><button class="dropdown-item" type="button"
                                                onclick="exportTableData('seller_return_request_table','json')">JSON</button>
                                        </li>
                                        <li><button class="dropdown-item" type="button"
                                                onclick="exportTableData('seller_return_request_table','sql')">SQL</button>
                                        </li>
                                        <li><button class="dropdown-item" type="button"
                                ...
                                <div class="pt-0">
                                    <div id="return_requests_table">
                                        <div class="table-responsive">
                                            <table id="seller_return_request_table" data-toggle="table"
                                                data-loading-template="loadingTemplate"
                                                data-url="{{ route('seller.return_requests.list') }}"
...
@section('scripts')
    <script>
        ...
        $(document).on('click', '.approve-return', function() {
            var id = $(this).data('id');
            $.post('{{ route('seller.return_requests.approve', ':id') }}'.replace(':id', id), {
                _token: '{{ csrf_token() }}'
            }, function(response) {
                alert(response.message);
                $('#view_return_request_modal').modal('hide');
                $('#seller_return_request_table').bootstrapTable('refresh');
            });
        });

        $(document).on('click', '.decline-return', function() {
            var id = $(this).data('id');
            $.post('{{ route('seller.return_requests.decline', ':id') }}'.replace(':id', id), {
                _token: '{{ csrf_token() }}'
            }, function(response) {
                alert(response.message);
                $('#view_return_request_modal').modal('hide');
        ...
        function queryParams(params) {
            return {
                ...
                pagination_offset: (params.pageNumber - 1) * params.pageSize,

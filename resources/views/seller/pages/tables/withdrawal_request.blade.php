        ...
        <div class="row">
            <div class="d-flex row align-items-center">
                <div class="col-md-6 page-info-title">
                    <h3>{{ labels('admin_labels.withdrawal_requests', 'Withdrawal Request') }}</h3>
                    <p class="sub_title">
                        {{ labels('admin_labels.effortlessly_process_and_track_withdrawel_requests', 'Effortlessly Process and Track Withdrawal Requests') }}
                    </p>
                </div>
                                ...
                                <div class="col-md-12 col-xxl-6 d-flex justify-content-end ">
                                    ...
                                    <div class="dropdown">
                                        ...
                                        <ul class="dropdown-menu" aria-labelledby="exportOptionsDropdown">
                                            <li><button class="dropdown-item" type="button" onclick="exportTableData('seller_withdrawal_request_table','csv')">CSV</button></li>
                                            <li><button class="dropdown-item" type="button" onclick="exportTableData('seller_withdrawal_request_table','json')">JSON</button></li>
                                            <li><button class="dropdown-item" type="button" onclick="exportTableData('seller_withdrawal_request_table','sql')">SQL</button></li>
                                            <li><button class="dropdown-item" type="button" onclick="exportTableData('seller_withdrawal_request_table','excel')">Excel</button></li>
                                        </ul>
                                    </div>
                                </div>
                            </div>

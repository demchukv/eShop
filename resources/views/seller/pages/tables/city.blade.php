        ...
        <div class="row">
            <div class="d-flex row align-items-center">
                <div class="col-md-12 col-xxl-6 page-info-title">
                    <h3>{{ labels('admin_labels.city', 'City') }}</h3>
                    <p class="sub_title">
                        {{ labels(
                    ...
                    <nav aria-label="breadcrumb" class="float-end">
                        <ol class="breadcrumb">
                            ...
                            <li class="breadcrumb-item active" aria-current="page">
                                {{ labels('admin_labels.city', 'City') }}</li>
                        </ol>
                    </nav>
                </div>
            </div>
                                ...
                                <div class="col-md-12 col-lg-6 d-flex justify-content-end">
                                    ...
                                    <div class="dropdown">
                                        ...
                                        <ul class="dropdown-menu" aria-labelledby="exportOptionsDropdown">
                                            <li><button class="dropdown-item" type="button" onclick="exportTableData('seller_city_table','csv')">CSV</button></li>
                                            <li><button class="dropdown-item" type="button" onclick="exportTableData('seller_city_table','json')">JSON</button></li>
                                            <li><button class="dropdown-item" type="button" onclick="exportTableData('seller_city_table','sql')">SQL</button></li>
                                            <li><button class="dropdown-item" type="button" onclick="exportTableData('seller_city_table','excel')">Excel</button></li>
                                        </ul>
                                    </div>
                                </div>
                            </div>

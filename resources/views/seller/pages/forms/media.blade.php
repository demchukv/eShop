            ...
            <div class="row">
                <div class="d-flex row align-items-center">
                    <div class="col-md-6 page-info-title">
                        ...
                        <p class="sub_title">
                            {{ labels('admin_labels.take_command_of_your_media', 'Take Command Of Your Media') }}
                        </p>
                    </div>
            ...
            <section class="overview-data">
                <div class="card content-area p-4 ">
                    ...
                    <div class="tab-content p-3 col-md-12" id="nav-tabContent">
                        ...
                        <div class="tab-pane fade " id="media-upload" role="tabpanel"
                            aria-labelledby="media-upload-tab">

            ...
            <div class="row">
                <div class="d-flex row align-items-center">
                    <div class="col-md-6 page-info-title">
                        <h3>{{ labels('admin_labels.point_of_sale', 'Point Of Sale') }}</h3>
                        <p class="sub_title">
                            {{ labels('admin_labels.grow_your_sales_with_the_right_tools', 'Grow Your Sales With The Right Tools') }}
                        </p>
                    </div>
                    <div class="col-md-6">
                        <nav aria-label="breadcrumb" class="float-end">
                            <ol class="breadcrumb">
                                ...
                                <li class="breadcrumb-item">{{ labels('admin_labels.manage', 'Manage') }}</li>
                        ...
                        <form id="pos_form" method="POST" action='{{ route('place.order') }}'>
                            ...
                            <div class="card mt-5 p-5">
                                ...
                                <div class="col-md-12 mt-5">
                                    ...
                                    <button type="button" class="btn btn-primary mt-5 float-end cart_product_payment" data-bs-toggle="modal"
                        ...
                        <form id="combo_product_form" method="POST" action="{{ route('combo.place.order') }}">
                            ...
                            <div class="card mt-5 p-5">
                                ...
                                <div class="col-md-12 mt-5">
                                    ...
                                    <button type="button" class="btn btn-primary mt-5 float-end cart_combo_product_payment" data-bs-toggle="modal"
                            ...
                            <div class="form-group">
                                ...
                                <div class="form-group">
                                    <div class="mb-3">
                                        <label class="form-label"
                                            for="mobile">{{ labels('admin_labels.mobile', 'Mobile') }}</label>
                                        <input type="number" class="form-control" placeholder="Mobile" id="mobile" maxlength="16" oninput="validateNumberInput(this)"
                            ...
                            <div class="form-group">
                                ...
                                <div class="form-group">
                                    <div class="mb-3">
                                        <label class="form-label"
                                            for="mobile">{{ labels('admin_labels.mobile', 'Mobile') }}</label>
                                        <input type="number" class="form-control customer_mobile" placeholder="Mobile" maxlength="16" oninput="validateNumberInput(this)"
                                            id="mobile" name="mobile" min='0' value="{{ old('mobile') }}">
                                    </div>
                                </div>
                                <div class="form-group">
                                    <div class="mb-3 country_list_div">
                            ...
                            <div class="form-group">
                                ...
                                <div class="form-group">
                                    <div class="mb-3">
                                        <label class="form-label"
                                            for="mobile">{{ labels('admin_labels.mobile', 'Mobile') }}</label>
                                        <input type="number" class="form-control combo_customer_mobile" maxlength="16" oninput="validateNumberInput(this)"
                                            placeholder="Mobile" id="mobile" name="mobile" min='0'
                                            value="{{ old('mobile') }}">
                                    </div>
                                </div>
                                <div class="form-group">

        ...
        <div class="d-flex flex-column justify-content-center align-items-center">
            <div class="card w-75">
                <div class="card-body">
                    ...
                    <form action="{{ route('seller.register.store') }}" enctype="multipart/form-data"
                        class="submit_form" method="POST">
                        @csrf
                                            ...
                                            <div class="row">
                                                ...
                                                <div class="mb-3 col-md-12 form-password-toggle">
                                                    ...
                                                    <textarea name="address" class="form-control"
                                                        placeholder="Write here your address">{{ old('address') }}</textarea>
                                                ...
                                                <div class="form-group col-md-12">
                                                    <div class="mb-3">
                                                        <label class="form-label"
                                                            ...
                                                            <span class="text-asterisks text-sm">*</span></label>
                                                        <textarea id="basic-default-message" value="" name="description"
                                                            class="form-control"

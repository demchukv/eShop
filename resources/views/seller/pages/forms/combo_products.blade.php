                ...
                <div class="col-xxl-12 p-0">
                    <div class="row cols-5 d-flex">
                        ...
                        <div class="col-md-12 col-xl-9 mt-md-2 mt-sm-2 mt-xl-0">
                            <form action="{{ route('seller.combo_products.store') }}" class="submit_form"
                                ...
                                <div class="card2 first-screen ml-2 show">
                                    ...
                                    <div class="float-end ml-2 mt-xxl-3 mt-7 combo-next-button text-center"
                                        data-step="step1">
                                        <button type="button"
                                            ...
                                            <div class="card p-5">
                                                ...
                                                <div class="row">
                                                    ...
                                                    <div class="form-group digital_product_in_combo col-md-12 d-none">
                                                        <div class="mb-3">
                                                            <label class="form-label"
                                                                for="name">{{ labels('admin_labels.digital_product', 'Digital Products') }}<span
                                                                    class='text-asterisks text-sm'>*</span></label>
                                                            <select id="" name="digital_product_id[]"
                                                                value=""
                                                ...
                                                <div class="row">
                                                    <div class="form-group col-md-4">
                                                        <div class="d-flex justify-content-between align-items-center">
                                                            <label for="tags" class="form-label">Has similar
                                                                products?</label>
                                                    ...
                                                    <div class="col-md-12 col-xs-12 d-none" id='similar_product'>
                                                        ...
                                                        <select id="" name="similar_product_id[]" value=""
                                                            class="select2 form-select search_admin_combo_product  w-100"
                                                            multiple>
                                                        </select>
                                                    </div>
                                                </div>
                                                    ...
                                                    <div class="col-md-6">
                                                        <div class="form-group">
                                                            ...
                                                            <input type="number" class="form-control" value=""
                                                                name="minimum_free_delivery_order_qty" min=1>
                                                        </div>
                                                    </div>

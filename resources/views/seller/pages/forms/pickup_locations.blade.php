        ...
        <div class="container-fluid mt-5 mb-5 px-6">
            <div class="d-flex align-items-center">
                <div class="col-md-6 page-info-title">
                    <h3>{{ labels('admin_labels.pickup_locations', 'Pickup Locations') }}
                    </h3>
                    <p class="sub_title">
                        {{ labels('admin_labels.add_pickup_location_with_power_and_simplicity', 'Add pickup location with power and simplicity') }}
                    </p>
                </div>
                                ...
                                <div class="col-md-12 col-lg-6 d-flex justify-content-end ">
                                    ...
                                    <div class="dropdown">
                                        ...
                                        <ul class="dropdown-menu" aria-labelledby="exportOptionsDropdown">
                                            <li><button class="dropdown-item" type="button" onclick="exportTableData('seller_pickup_location_table','csv')">CSV</button></li>
                                            <li><button class="dropdown-item" type="button" onclick="exportTableData('seller_pickup_location_table','json')">JSON</button></li>
                                            <li><button class="dropdown-item" type="button" onclick="exportTableData('seller_pickup_location_table','sql')">SQL</button></li>
                                            <li><button class="dropdown-item" type="button" onclick="exportTableData('seller_pickup_location_table','excel')">Excel</button></li>
                                        </ul>
                                    </div>
                                </div>
                            </div>
                                ...
                                <div class="col-md-12">
                                    <div class="pt-0">
                                        <div class="table-responsive">
                                            <table id='seller_pickup_location_table' data-toggle="table" data-loading-template="loadingTemplate"
                            ...
                            <div class="col-md-6">
                                <div class="form-group">
                                    <label for="phone"
                                        ...
                                        <span class='text-asterisks text-sm'>*</span></label>
                                    <input type="text" class="form-control" name="phone" maxlength="16" oninput="validateNumberInput(this)"
                                        placeholder="Shipper's phone number." id="phone" value="">
                                </div>
                            </div>
                        </div>
                        <div class="row">

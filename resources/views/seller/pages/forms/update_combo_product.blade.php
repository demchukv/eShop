...
@section('title')
    {{ labels('admin_labels.products', 'Combo Products') }}
@endsection
@section('content')
            ...
            <div class="row">
                <div class="d-flex row align-items-center">
                    <div class="col-md-6 page-info-title">
                        <h3>{{ labels('admin_labels.combo_product', 'Update Combo Product') }}</h3>
                        <p class="sub_title">
                            {{ labels('admin_labels.take_command_of_your_media', 'Update combo products with power and simplicity') }}
                        </p>
                    </div>
                            ...
                            <div class="card p-5">
                                <div class="card1">
                                    <ul id="progressbar" class="text-center">
                                        ...
                                        <li class="step0"></li>
                                        <li class="step0"></li>
                                        <li class="step0 {{ $data->product_type == 'digital_product' ? 'd-none' : '' }}">
                                        </li>
                                        <li class="step0 {{ $data->product_type == 'digital_product' ? 'd-none' : '' }}">
                                        </li>
                                        <li class="step0"></li>
                                    ...
                                    <div class="row">
                                        <div class="col col-xxl-12">
                                            <div class="card p-5">
                                                ...
                                                <div class="row">
                                                    <div
                                                        class="form-group physical_product_in_combo col-md-12 {{ isset($data->id) && $data->product_type != 'digital_product' ? '' : 'd-none' }}">
                                                ...
                                                <div class="row">
                                                    <div class="col-md-6">
                                                        <div class="form-group">
                                                            ...
                                                            @endphp
                                                            <label for="pro_input_tax" class="form-label">{{ labels('admin_labels.select_tax', 'Select Tax') }}</label>
                                                            <select name="pro_input_tax[]" class="tax_list form-select w-100" multiple>
                                                                @php
                                                                    $tax_name = fetchDetails('taxes', "", ['title', 'percentage', 'id'], "", "", "", "", "id", $taxes);
                                                                @endphp
                                        ...
                                        <div class="col col-xxl-12">
                                            <div class="card p-5">
                                                ...
                                                <div class="row">
                                                    ...
                                                    @php
                                                    $zones = isset($data->deliverable_zones) && $data->deliverable_zones != null ? explode(',', $data->deliverable_zones) : [];
                                                                ...
                                                                @if (!empty($other_images))
                                                                    @foreach ($other_images as $row)
                                                                        <div
                                                                            ...
                                                                            <a href="javascript:void(0)"
                                                                                class="remove-image text-danger"
                                                                                data-id="<?= $data->id ?>"

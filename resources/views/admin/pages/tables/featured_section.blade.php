...
@section('content')
    <div class="d-flex row align-items-center">
        <div class="col-md-6 col-xl-6 page-info-title">
            <h3>{{ labels('admin_labels.featured_section', 'Featured Section') }}
            </h3>
            <p class="sub_title">
            ...
            <div class="col-md-12 col-xxl-6">
                <div class="card">
                    <div class="card-body ">
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-md-12">
                                <input type="text" class="form-control" name="short_description" id="short_description"
                                    value="" placeholder="Short description">
                            </div>
                        </div>
                        ...
                        <div class="form-group row">
                            @php
                                $product_type = ['new_added_products', 'products_on_sale', 'top_rated_products', 'most_selling_products', 'custom_products', 'digital_product', 'custom_combo_products'];
                            @endphp
                            ...
                            <div class="col-md-12">
                                <select name="product_type" class="form-control product_type form-select">
                                    ...
                                    @foreach ($product_type as $row)
                                        <option value="{{ $row }}">{{ ucwords(str_replace('_', ' ', $row)) }}</option>
                                    @endforeach
                                </select>
                            </div>
                        </div>
                        ...
                        <div class="row">
                            <div class="col-md-6">
                                ...
                                <div class="feature_section_header_style_images feature_section_header_style_box">
                                    <img src="{{ getimageurl('system_images/feature_section_heading_style_1.png') }}" class="header_style_1" alt="Feature Section Heading Style 1">
                                    <img src="{{ getimageurl('system_images/feature_section_heading_style_2.png') }}" class="header_style_2" alt="Feature Section Heading Style 2">
                                    <img src="{{ getimageurl('system_images/feature_section_heading_style_3.png') }}" class="header_style_3" alt="Feature Section Heading Style 3">
                            ...
                            <div class="col-md-6 feature_section_style_main">
                                ...
                                <div class="feature_section_style_images feature_section_style_box">
                                    <img src="{{ getimageurl('system_images/featured_section_style_1.png') }}" class="style_1" alt="Featured Section Style 1">
<img src="{{ getimageurl('system_images/featured_section_style_2.png') }}" class="style_2" alt="Featured Section Style 2">
<img src="{{ getimageurl('system_images/featured_section_style_3.png') }}" class="style_3" alt="Featured Section Style 3">
    ...
    <div class="col-md-12 mt-4 {{  $user_role== 'super_admin' || $logged_in_user->hasPermissionTo('view featured_section') ? '' : 'd-none' }}">
                                ...
                                <div class="col-md-12 col-lg-6 d-flex justify-content-end mt-md-2 mt-lg-0">
                                    ...
                                    <div class="dropdown">
                                        ...
                                        <ul class="dropdown-menu" aria-labelledby="exportOptionsDropdown">
                                            <li><button class="dropdown-item" type="button" onclick="exportTableData('admin_featured_section_table','csv')">CSV</button></li>
                                            <li><button class="dropdown-item" type="button" onclick="exportTableData('admin_featured_section_table','json')">JSON</button></li>
                                            <li><button class="dropdown-item" type="button" onclick="exportTableData('admin_featured_section_table','sql')">SQL</button></li>
                                            <li><button class="dropdown-item" type="button" onclick="exportTableData('admin_featured_section_table','excel')">Excel</button></li>
                                        </ul>
                                    </div>
                                </div>
                        </div>

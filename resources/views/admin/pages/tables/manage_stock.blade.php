...
@section('content')
    <div class="d-flex row align-items-center">
            <div class="col-md-6 col-xl-6 page-info-title">
                <h3>{{ labels('admin_labels.stock_manage', 'Stock Manage') }}</h3>
                <p class="sub_title">
                    {{ labels('admin_labels.know_your_stock_grow_your_business', 'Know your stock, grow your business') }}
                </p>
            </div>
        <div class="col-md-6 col-xl-6 d-flex justify-content-end">
            <nav aria-label="breadcrumb" class="float-end">
                <ol class="breadcrumb">
                    ...
                    <li class="breadcrumb-item active">{{ labels('admin_labels.stock_manage', 'Stock Manage') }}</li>
                </ol>
            </nav>
        </div>
    </div>
                        ...
                        <div class="col-md-12 col-lg-6 d-flex justify-content-end">
                            ...
                            <div class="dropdown">
                                ...
                                <ul class="dropdown-menu" aria-labelledby="exportOptionsDropdown">
                                    <li><button class="dropdown-item" type="button" onclick="exportTableData('admin_product_stock_table','csv')">CSV</button></li>
                                    <li><button class="dropdown-item" type="button" onclick="exportTableData('admin_product_stock_table','json')">JSON</button></li>
                                    <li><button class="dropdown-item" type="button" onclick="exportTableData('admin_product_stock_table','sql')">SQL</button></li>
                                    <li><button class="dropdown-item" type="button" onclick="exportTableData('admin_product_stock_table','excel')">Excel</button></li>
                                </ul>
                            </div>
                        </div>
                    </div>
                ...
                <div class="col-md-12">
                    <div class="pt-0">
                        <div class="table-responsive">
                            <table id='admin_product_stock_table' data-toggle="table" data-loading-template="loadingTemplate"

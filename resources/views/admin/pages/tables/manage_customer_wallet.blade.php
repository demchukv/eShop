...
@section('content')
    <div class="d-flex row align-items-center">
        <div class="col-md-6 col-xl-6 page-info-title">
            <h3>{{ labels('admin_labels.wallet_transaction', 'Wallet Transaction') }}
            </h3>
            <p class="sub_title">
                {{ labels('admin_labels.track_and_manage_wallet_transactions_with_precision', 'Track and Manage Wallet Transactions with Precision') }}
            </p>
        </div>
            ...
            <nav aria-label="breadcrumb" class="float-end">
                <ol class="breadcrumb">
                    ...
                    <li class="breadcrumb-item second_breadcrumb_item">
                        {{ labels('admin_labels.customers', 'Customers') }}</li>
    ...
    <div class="modal fade" id="add_wallet_transaction" tabindex="-1" role="dialog"
    ...
    {{-- table  --}}
    <section class="overview-data {{  $user_role== 'super_admin' || $logged_in_user->hasPermissionTo('view customer_wallet_transaction') ? '' : 'd-none' }}">
                            ...
                            <div class="col-md-12 col-xxl-6 d-flex justify-content-end ">
                                ...
                                <div class="dropdown">
                                    ...
                                    <ul class="dropdown-menu" aria-labelledby="exportOptionsDropdown">
                                        <li><button class="dropdown-item" type="button" onclick="exportTableData('admin_customer_wallet_table','csv')">CSV</button></li>
                                        <li><button class="dropdown-item" type="button" onclick="exportTableData('admin_customer_wallet_table','json')">JSON</button></li>
                                        <li><button class="dropdown-item" type="button" onclick="exportTableData('admin_customer_wallet_table','sql')">SQL</button></li>
                                        <li><button class="dropdown-item" type="button" onclick="exportTableData('admin_customer_wallet_table','excel')">Excel</button></li>
                                    </ul>
                                </div>
                            </div>
                    </div>
                        ...
                        <div class="pt-0">
                            <div class="table-responsive">
                                <table class='table' id="admin_customer_wallet_table" data-toggle="table"
                                    ...
                                    data-url="{{ route('admin.customers.getTransactionList') }}"

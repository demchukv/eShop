...
@section('content')
    <div class="d-flex row align-items-center">
        <div class="col-md-6 col-xl-6 page-info-title">
            <h3>{{ labels('admin_labels.manage_orders', 'Manage Orders') }}
            </h3>
            <p class="sub_title">
                {{ labels('admin_labels.all_information_about_orders', 'All Information About Orders') }}
            </p>
        </div>
            ...
            <nav aria-label="breadcrumb" class="float-end">
                <ol class="breadcrumb">
                    ...
                    <li class="breadcrumb-item second_breadcrumb_item">
                        {{ labels('admin_labels.manage_orders', 'Manage Orders') }}</li>
                                    ...
                                    <div class="row">
                                        <div class="col-md-12 d-flex justify-content-end ">
                                            <div class="input-group me-2 search-input-grp ">
                                                ...
                                                <input type="text"
                                                    data-table="admin_order_tracking_table" class="form-control searchInput"
                                                    placeholder="Search...">
                                                <span
                                            ...
                                            <a class="btn me-2" id="tableRefresh"
                                                data-table="admin_order_tracking_table"><i class='bx bx-refresh'></i></a>
                                            <div class="dropdown">
                                                ...
                                                <ul class="dropdown-menu" aria-labelledby="exportOptionsDropdown">
                                                    <li><button class="dropdown-item" type="button" onclick="exportTableData('admin_order_tracking_table','csv')">CSV</button></li>
                                                    <li><button class="dropdown-item" type="button" onclick="exportTableData('admin_order_tracking_table','json')">JSON</button></li>
                                                    <li><button class="dropdown-item" type="button" onclick="exportTableData('admin_order_tracking_table','sql')">SQL</button></li>
                                                    <li><button class="dropdown-item" type="button" onclick="exportTableData('admin_order_tracking_table','excel')">Excel</button></li>
                                                </ul>
                                            </div>
                                        </div>
                                    </div>
                                ...
                                <div class="col-md-12">
                                    <div class="pt-0">
                                        <div class="table-responsive">
                                            <table class='table' id="admin_order_tracking_table" data-toggle="table" data-loading-template="loadingTemplate"
            ...
            <div class="modal-content">
                ...
                <form class="form-horizontal " id="order_tracking_form"
                    ...
                    <div class="modal-body">
                        ...
                        <div class="form-group ">
                            <label
                                for="url">{{ labels('admin_labels.url', 'URL') }}</label>
                ...
                <div class="col-md-12">
                    <div class="row">
                        ...
                        <div class="col-md-12 d-flex justify-content-end ">
                            ...
                            <div class="input-group me-2 search-input-grp ">
                                <span class="search-icon"><i class='bx bx-search-alt'></i></span>
                                <input type="text" data-table="admin_order_table"
                            ...
                            <div class="dropdown">
                                ...
                                <ul class="dropdown-menu" aria-labelledby="exportOptionsDropdown">
                                    <li><button class="dropdown-item" type="button" onclick="exportTableData('admin_order_table','csv')">CSV</button></li>
                                    <li><button class="dropdown-item" type="button" onclick="exportTableData('admin_order_table','json')">JSON</button></li>
                                    <li><button class="dropdown-item" type="button" onclick="exportTableData('admin_order_table','sql')">SQL</button></li>
                                    <li><button class="dropdown-item" type="button" onclick="exportTableData('admin_order_table','excel')">Excel</button></li>
                                </ul>
                            </div>
                        </div>
                    </div>
                    <div class="row">
                        <div class="col-md-12">
                            <div class="pt-0">
                                <div class="table-responsive">
                                    <table class='table' id="admin_order_table" data-toggle="table" data-loading-template="loadingTemplate"

...
@section('content')
    <div class="d-flex row align-items-center">
        <div class="col-md-6 col-xl-6 page-info-title">
            <h3>{{ labels('admin_labels.customers', 'Customers') }}
            </h3>
            <p class="sub_title">
                {{ labels('admin_labels.optimize_and_manage_customers', 'Optimize and Manage Customers') }}
            </p>
        </div>
    ...
    {{-- table --}}
    <div class="col-md-12 mt-4 {{  $user_role== 'super_admin' || $logged_in_user->hasPermissionTo('view customers') ? '' : 'd-none' }}">

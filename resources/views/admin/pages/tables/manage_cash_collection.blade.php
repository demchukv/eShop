...
@section('content')
    <div class="d-flex row align-items-center">
        <div class="col-md-6 col-xl-6 page-info-title">
            <h3> {{ labels('admin_labels.cash_collection', 'Cash Collection') }}
            </h3>
            <p class="sub_title">
                {{ labels('admin_labels.track_and_manage_delivery_boy_cash_collection_with_precision', 'Track and Manage Delivery Boy Cash Collection with Precision') }}
            </p>
        </div>
    ...
    <div class="modal fade" id="cash_collection_modal" tabindex="-1" role="dialog"
    ...
    <section class="overview-data {{  $user_role== 'super_admin' || $logged_in_user->hasPermissionTo('view delivery_boy_cash_collection') ? '' : 'd-none' }}">
                        ...
                        <div class="col-md-12 col-lg-6 col-xl-4">
                            ...
                            <div class="col-lg-12 col-md-12 col-xl-8 d-flex justify-content-end">
                                ...
                                <a class="btn me-2" id="tableFilter" data-bs-toggle="offcanvas"
                                    ...
                                    data-table="admin_delivery_boy_cash_collection" dateFilter='true'
                                    cashCollectionTypeFilter='true' deliveryBoyFilter='true'><i
                                ...
                                <div class="dropdown">
                                    ...
                                    <ul class="dropdown-menu" aria-labelledby="exportOptionsDropdown">
                                        <li><button class="dropdown-item" type="button" onclick="exportTableData('admin_delivery_boy_cash_collection','csv')">CSV</button></li>
                                        <li><button class="dropdown-item" type="button" onclick="exportTableData('admin_delivery_boy_cash_collection','json')">JSON</button></li>
                                        <li><button class="dropdown-item" type="button" onclick="exportTableData('admin_delivery_boy_cash_collection','sql')">SQL</button></li>
                                        <li><button class="dropdown-item" type="button" onclick="exportTableData('admin_delivery_boy_cash_collection','excel')">Excel</button></li>
                                    </ul>
                                </div>
                            </div>
                    </div>

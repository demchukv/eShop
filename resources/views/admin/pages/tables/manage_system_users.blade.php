...
@section('content')
    <div class="d-flex row align-items-center">
        <div class="col-md-6 col-xl-6 page-info-title">
            <h3>{{ labels('admin_labels.manage_system_users', 'Manage System Users') }}
            </h3>
            <p class="sub_title">
                {{ labels('admin_labels.effortlessly_administer_and_control_system_users', 'Effortlessly Administer and Control System Users') }}
            </p>
        </div>
                        ...
                        <div class="col-md-12 col-lg-6">
                            ...
                            <div class="col-md-12 col-lg-6 d-flex justify-content-end ">
                                <div class="input-group me-2 search-input-grp ">
                                    ...
                                    <input type="text" data-table="admin_system_users_table"
                                ...
                                <div class="dropdown">
                                    ...
                                    <ul class="dropdown-menu" aria-labelledby="exportOptionsDropdown">
                                        <li><button class="dropdown-item" type="button" onclick="exportTableData('admin_system_users_table','csv')">CSV</button></li>
                                        <li><button class="dropdown-item" type="button" onclick="exportTableData('admin_system_users_table','json')">JSON</button></li>
                                        <li><button class="dropdown-item" type="button" onclick="exportTableData('admin_system_users_table','sql')">SQL</button></li>
                                        <li><button class="dropdown-item" type="button" onclick="exportTableData('admin_system_users_table','excel')">Excel</button></li>
                                    </ul>
                                </div>
                            </div>
                    </div>

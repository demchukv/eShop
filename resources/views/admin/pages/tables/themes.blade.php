...
@section('content')
    <div class="d-flex row align-items-center">
        <div class="col-md-6 col-xl-6 page-info-title">
            <h3>{{ labels('admin_labels.theme', 'Theme') }}</h3>
            <p class="sub_title">
                {{ labels('admin_labels.customize_your_web_with_essential_theme_settings', 'Customize Your Web With Essential Theme Settings') }}
            </p>
        </div>
            ...
            <nav aria-label="breadcrumb" class="float-end">
                <ol class="breadcrumb">
                    ...
                    <li class="breadcrumb-item active" aria-current="page">
                        {{ labels('admin_labels.manage_themes', 'Manage Themes') }}
                    </li>
                </ol>
            </nav>
        </div>
                        ...
                        <div class="row">
                            ...
                            <div class="col-sm-12 col-lg-6 d-flex justify-content-end mt-sm-2">
                                <div class="input-group me-2 search-input-grp ">
                                    ...
                                    <input type="text" data-table="admin_theme_table"
                                ...
                                <div class="dropdown">
                                    ...
                                    <ul class="dropdown-menu" aria-labelledby="exportOptionsDropdown">
                                        <li><button class="dropdown-item" type="button" onclick="exportTableData('admin_theme_table','csv')">CSV</button></li>
                                        <li><button class="dropdown-item" type="button" onclick="exportTableData('admin_theme_table','json')">JSON</button></li>
                                        <li><button class="dropdown-item" type="button" onclick="exportTableData('admin_theme_table','sql')">SQL</button></li>
                                        <li><button class="dropdown-item" type="button" onclick="exportTableData('admin_theme_table','excel')">Excel</button></li>
                                    </ul>
                                </div>
                            </div>
                        </div>
                    ...
                    <div class="col-md-12">
                        <div class="pt-0">
                            <div class="table-responsive">
                                <table class='table' id="admin_theme_table" data-toggle="table" data-loading-template="loadingTemplate"
                                    data-url="{{ route('admin.theme_list') }}" data-click-to-select="true"

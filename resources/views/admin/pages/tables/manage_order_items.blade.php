...
@section('content')
    <div class="d-flex row align-items-center">
        <div class="col-md-6 col-xl-6 page-info-title">
            <h3>{{ labels('admin_labels.manage_order_items', 'Manage Order Items') }}
            </h3>
            <p class="sub_title">
                {{ labels('admin_labels.all_information_about_order_items', 'All Information About Order Items') }}
            </p>
        </div>
            ...
            <nav aria-label="breadcrumb" class="float-end">
                <ol class="breadcrumb">
                    ...
                    <li class="breadcrumb-item active" aria-current="page">
                        {{ labels('admin_labels.order_items', 'Order Items') }}
                    </li>
                </ol>
            </nav>
        </div>
                                ...
                                <div class="col-md-4 d-flex justify-content-end">
                                    ...
                                    <div class="dropdown">
                                        ...
                                        <ul class="dropdown-menu" aria-labelledby="exportOptionsDropdown">
                                            <li><button class="dropdown-item" type="button" onclick="exportTableData('admin_order_items_table','csv')">CSV</button></li>
                                            <li><button class="dropdown-item" type="button" onclick="exportTableData('admin_order_items_table','json')">JSON</button></li>
                                            <li><button class="dropdown-item" type="button" onclick="exportTableData('admin_order_items_table','sql')">SQL</button></li>
                                            <li><button class="dropdown-item" type="button" onclick="exportTableData('admin_order_items_table','excel')">Excel</button></li>
                                        </ul>
                                    </div>
                                </div>
                            </div>
                    ...
                    <div class="row">
                        <div class="col-md-12">
                            <div class="table-responsive">
                                <table id="admin_order_items_table" class="table" data-toggle="table" data-loading-template="loadingTemplate"

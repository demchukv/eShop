...
@section('content')
    <div class="d-flex row align-items-center">
        <div class="col-md-6 col-xl-6 page-info-title">
            <h3>{{ labels('admin_labels.manage_pickup_locations', 'Manage Pickup Locations') }}
            </h3>
            <p class="sub_title">
                {{ labels('admin_labels.all_information_about_pickup_locations', 'All Information About Pickup Locations') }}
            </p>
        </div>
            ...
            <nav aria-label="breadcrumb" class="float-end">
                <ol class="breadcrumb">
                    ...
                    <li class="breadcrumb-item">
                        {{ labels('admin_labels.location_management', 'Location Management') }}
                    </li>
                        ...
                        <div class="col-md-12 d-flex justify-content-end ">
                                ...
                                <div class="dropdown">
                                    ...
                                    <ul class="dropdown-menu" aria-labelledby="exportOptionsDropdown">
                                        <li><button class="dropdown-item" type="button" onclick="exportTableData('admin_pickup_location_table','csv')">CSV</button></li>
                                        <li><button class="dropdown-item" type="button" onclick="exportTableData('admin_pickup_location_table','json')">JSON</button></li>
                                        <li><button class="dropdown-item" type="button" onclick="exportTableData('admin_pickup_location_table','sql')">SQL</button></li>
                                        <li><button class="dropdown-item" type="button" onclick="exportTableData('admin_pickup_location_table','excel')">Excel</button></li>
                                    </ul>
                                </div>
                        </div>
                    </div>

...
@section('content')
    <div class="d-flex row align-items-center">
        <div class="col-md-6 col-xl-6 page-info-title">
            <h3>{{ labels('admin_labels.ticket', 'Ticket') }}</h3>
            <p class="sub_title">
                {{ labels('admin_labels.streamline_support_with_efficient_ticket_management', 'Streamline Support with Efficient Ticket Management') }}
            </p>
        </div>
            ...
            <nav aria-label="breadcrumb" class="float-end">
                <ol class="breadcrumb">
                    ...
                    <li class="breadcrumb-item active" aria-current="page">
                        {{ labels('admin_labels.manage_tickets', 'Manage Tickets') }}
                    </li>
                </ol>
            </nav>
        </div>
                            ...
                            <div class="col-sm-12 col-lg-6 d-flex justify-content-end mt-sm-2">
                                ...
                                <div class="dropdown">
                                    ...
                                    <ul class="dropdown-menu" aria-labelledby="exportOptionsDropdown">
                                        <li><button class="dropdown-item" type="button" onclick="exportTableData('admin_ticket_table','csv')">CSV</button></li>
                                        <li><button class="dropdown-item" type="button" onclick="exportTableData('admin_ticket_table','json')">JSON</button></li>
                                        <li><button class="dropdown-item" type="button" onclick="exportTableData('admin_ticket_table','sql')">SQL</button></li>
                                        <li><button class="dropdown-item" type="button" onclick="exportTableData('admin_ticket_table','excel')">Excel</button></li>
                                    </ul>
                                </div>
                            </div>
                        </div>

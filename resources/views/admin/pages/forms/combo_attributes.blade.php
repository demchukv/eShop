...
@section('content')
    ...
    <div class="col-md-12">
        <div class="row">
            ...
            {{-- table  --}}
            <div class="col-lg-8 col-md-6 col-sm-12 mt-md-2 mt-sm-2 {{ $user_role== 'super_admin' || $logged_in_user->hasPermissionTo('view combo_attributes') ? '' : 'd-none' }}">
                                    ...
                                    <div class="col-md-6">
                                        ...
                                        <div class="col-sm-12 d-flex justify-content-end mt-md-0 mt-sm-2">
                                            ...
                                            <a class="btn me-2" id="tableFilter" data-bs-toggle="offcanvas"
                                                ...
                                                data-table="admin_combo_attribute_table" dateFilter='false'
                                            ...
                                            <div class="dropdown">
                                                ...
                                                <ul class="dropdown-menu" aria-labelledby="exportOptionsDropdown">
                                                    <li><button class="dropdown-item" type="button" onclick="exportTableData('admin_combo_attribute_table','csv')">CSV</button></li>
                                                    <li><button class="dropdown-item" type="button" onclick="exportTableData('admin_combo_attribute_table','json')">JSON</button></li>
                                                    <li><button class="dropdown-item" type="button" onclick="exportTableData('admin_combo_attribute_table','sql')">SQL</button></li>
                                                    <li><button class="dropdown-item" type="button" onclick="exportTableData('admin_combo_attribute_table','excel')">Excel</button></li>
                                                </ul>
                                            </div>
                                        </div>
                                </div>

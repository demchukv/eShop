...
@section('content')
    <div class="d-flex row align-items-center">
        <div class="col-md-6 col-xl-6 page-info-title">
            <h3>{{ labels('admin_labels.pusher_setting', 'Pusher Setting') }}
            </h3>
            <p class="sub_title">
                {{ labels('admin_labels.ensure_seamless_chat_integration_with_advanced_pusher_settings', 'Ensure Seamless Chat Integration with Advanced Pusher Settings') }}
            </p>
        </div>

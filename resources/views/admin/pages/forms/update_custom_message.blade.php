...
@section('content')
    <div class="d-flex row align-items-center">
        <div class="col-md-6 col-xl-6 page-info-title">
            <h3>{{ labels('admin_labels.custom_message', 'Custom Message') }}</h3>
            <p class="sub_title">
                {{ labels('admin_labels.craft_personalized_messages_with_custom_message_management', 'Craft Personalized Messages with Custom Message Management') }}
            </p>
        </div>
            ...
            <nav aria-label="breadcrumb" class="float-end">
                <ol class="breadcrumb">
                    ...
                    <li class="breadcrumb-item active" aria-current="page">
                        {{ labels('admin_labels.custom_message', 'Custom Message') }}</li>
                </ol>
            </nav>
        </div>
    </div>

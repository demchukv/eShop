...
@section('content')
    <div class="d-flex row align-items-center">
        <div class="col-md-6 col-xl-6 page-info-title">
            <h3>{{ labels('admin_labels.faqs', 'Faqs') }}</h3>
            <p class="sub_title">
                {{ labels('admin_labels.answer_queries_with_clarity_in_the_faqs_section', 'Answer Queries with Clarity in the FAQs Section') }}
            </p>
        </div>
            ...
            <nav aria-label="breadcrumb" class="float-end">
                <ol class="breadcrumb">
                    ...
                    <li class="breadcrumb-item active" aria-current="page">
                        {{ labels('admin_labels.faqs', 'Faqs') }}</li>
                </ol>
            </nav>
        </div>
    </div>
    <div class="col-md-12">
        <div class="row">
                ...
                <div class="card">
                    ...
                    <form class="form-horizontal submit_form" action="{{ route('faqs.store') }}" method="POST"
                        ...
                        <div class="card-body pt-0">
                            <div class="mb-3">
                                <label for="question"
                                    class="form-label">{{ labels('admin_labels.question', 'Question') }}
                                    <span class='text-asterisks text-xs'>*</span></label>
                                <input type="text" class="form-control" id="question" name="question">
                            </div>
                            <div class="mb-3">
                                <label for="answer"
                                    class="form-label">{{ labels('admin_labels.answer', 'Answer') }}
                                    <span class='text-asterisks text-xs'>*</span></label>
            ...
            <div class="col-lg-8 col-md-12 mt-md-2 mt-sm-2 {{  $user_role== 'super_admin' || $logged_in_user->hasPermissionTo('view faq') ? '' : 'd-none' }}">
                                    ...
                                    <div class="col-md-12 col-lg-6 d-flex justify-content-end mt-md-0 mt-sm-2">
                                        ...
                                        <div class="dropdown">
                                            ...
                                            <ul class="dropdown-menu" aria-labelledby="exportOptionsDropdown">
                                                <li><button class="dropdown-item" type="button" onclick="exportTableData('admin_faqs_table','csv')">CSV</button></li>
                                                <li><button class="dropdown-item" type="button" onclick="exportTableData('admin_faqs_table','json')">JSON</button></li>
                                                <li><button class="dropdown-item" type="button" onclick="exportTableData('admin_faqs_table','sql')">SQL</button></li>
                                                <li><button class="dropdown-item" type="button" onclick="exportTableData('admin_faqs_table','excel')">Excel</button></li>
                                            </ul>
                                        </div>
                                    </div>
                                </div>
                            ...
                            <div class="col-md-12">
                                <div class="pt-0">
                                    <div class="table-responsive">
                                        <table class='table' id="admin_faqs_table" data-toggle="table" data-loading-template="loadingTemplate"
                                            data-url="{{ route('faqs.list') }}" data-click-to-select="true"

...
@section('content')
    ...
    <div class="d-flex row align-items-center">
        <div class="col-md-6 col-xl-6 page-info-title">
            <h3>{{ labels('admin_labels.email_smtp_settings', 'Email SMTP Setting') }}
            </h3>
            <p class="sub_title">
                {{ labels('admin_labels.ensure_seamless_email_integration_with_advanced_smtp_settings', 'Ensure Seamless Email Integration with Advanced SMTP Settings') }}
            </p>
        </div>

...
@section('content')
    ...
    <div class="d-flex row align-items-center">
        <div class="col-md-6 col-xl-6 page-info-title">
            <h3>{{ labels('admin_labels.create_blog', 'Create Blog') }}</h3>
            <p class="sub_title">
            ...
            <nav aria-label="breadcrumb" class="float-end">
                <ol class="breadcrumb">
                    ...
                    <li class="breadcrumb-item active" aria-current="page">
                        {{ labels('admin_labels.create_blogs', 'Create Blogs') }}
                    </li>
                </ol>
            </nav>
        </div>
    ...
    <div class="row">
        ...
        <div class="col-md-12 main-content mt-4 {{ $user_role== 'super_admin' || $logged_in_user->hasPermissionTo('view blogs') ? '' : 'd-none' }}">
                                ...
                                <div class="col-sm-12 d-flex justify-content-end mt-md-0 mt-sm-2">
                                    ...
                                    <div class="dropdown">
                                        ...
                                        <ul class="dropdown-menu" aria-labelledby="exportOptionsDropdown">
                                            <li><button class="dropdown-item" type="button" onclick="exportTableData('admin_blog_table','csv')">CSV</button></li>
                                            <li><button class="dropdown-item" type="button" onclick="exportTableData('admin_blog_table','json')">JSON</button></li>
                                            <li><button class="dropdown-item" type="button" onclick="exportTableData('admin_blog_table','sql')">SQL</button></li>
                                            <li><button class="dropdown-item" type="button" onclick="exportTableData('admin_blog_table','excel')">Excel</button></li>
                                        </ul>
                                    </div>
                                </div>

...
@section('content')
    <div class="d-flex row align-items-center">
        <div class="col-md-6 col-xl-6 page-info-title">
            ...
            <p class="sub_title">
                {{ labels('admin_labels.enhance_visual_appeal_with_effortless_slider_integration', 'Enhance Visual Appeal with Effortless Slider Integration') }}
            </p>
        </div>
    ...
    <div class="row">
        ...
        {{-- table --}}
        <div class="col-md-8 mt-md-0 mt-sm-2 {{  $user_role== 'super_admin' || $logged_in_user->hasPermissionTo('view slider_images') ? '' : 'd-none' }}">
                                    ...
                                    <div class="col-sm-12 d-flex justify-content-end mt-md-0 mt-sm-2">
                                        ...
                                        <div class="dropdown">
                                            ...
                                            <ul class="dropdown-menu" aria-labelledby="exportOptionsDropdown">
                                                <li><button class="dropdown-item" type="button" onclick="exportTableData('admin_slider_table','csv')">CSV</button></li>
                                                <li><button class="dropdown-item" type="button" onclick="exportTableData('admin_slider_table','json')">JSON</button></li>
                                                <li><button class="dropdown-item" type="button" onclick="exportTableData('admin_slider_table','sql')">SQL</button></li>
                                                <li><button class="dropdown-item" type="button" onclick="exportTableData('admin_slider_table','excel')">Excel</button></li>
                                            </ul>
                                        </div>
                                    </div>
                            </div>
                                ...
                                <div class="pt-0">
                                    <div class="table-responsive">
                                        <table class='table' id="admin_slider_table" data-toggle="table"
                                            ...
                                            data-url="{{ route('sliders.list') }}" data-click-to-select="true"

...
@section('content')
    <div class="d-flex row align-items-center">
        <div class="col-md-6 col-xl-6 page-info-title">
            ...
            <h3>{{ labels('admin_labels.payment_methods', 'Payment Methods') }}
            </h3>
            <p class="sub_title">
                                    ...
                                    <div class="row">
                                        ...
                                        <div class="col-md-6">
                                            ...
                                            <select class="form-control form-select" name="currency_code">
                                                @php
                                                $currencyCodes = ['AUD', 'BRL', 'CAD', 'CNY', 'CZK', 'DKK', 'EUR', 'HKD', 'HUF', 'INR', 'ILS', 'JPY', 'MYR', 'MXN', 'TWD', 'NZD', 'NOK', 'PHP', 'PLN', 'GBP', 'RUB', 'SGD', 'SEK', 'CHF', 'THB', 'USD'];
                                            @endphp

                                            @foreach ($currencyCodes as $code)
                                                <option value="{{ $code }}" {{ isset($settings['currency_code']) && $settings['currency_code'] == $code ? 'selected' : '' }}>{{ $code }}</option>
                                            @endforeach
                                ...
                                <div class="row mt-4">
                                    ...
                                    <div class="col-md-6">
                                        ...
                                        <input type="text" class="form-control width" readonly name=""
                                            value="{{ url('admin/webhook/phonepe-webhook') }}" />
                                    </div>
                                </div>
                            </div>
                        </div>
                                    ...
                                    <div class="col-md-6">
                                       ...
                                       @php
                                            ...
                                            foreach ($currencyOptions as $code => $name) {
                                                $selected = isset($settings['stripe_currency_code']) && $settings['stripe_currency_code'] == $code ? 'selected' : '';

                                ...
                                <div data-repeater-item>
                                    <div class="row">
                                        <div class="col-md-5 mt-2">
                                            <select class="form-select zipcode_list" name="serviceable_zipcode_id" required id="">
                                                <option value=" ">
                            ...
                            <div class="row">
                                ...
                                <div class="col-sm-12 d-flex justify-content-end mt-md-0 mt-sm-2">
                                    <div class="input-group me-2 search-input-grp ">
                                        ...
                                        <input type="text" data-table="admin_zone_table" class="form-control searchInput"
                                            placeholder="Search...">
                                    ...
                                    <div class="dropdown">
                                        ...
                                        <ul class="dropdown-menu" aria-labelledby="exportOptionsDropdown">
                                            <li><button class="dropdown-item" type="button" onclick="exportTableData('admin_zone_table','csv')">CSV</button></li>
                                            <li><button class="dropdown-item" type="button" onclick="exportTableData('admin_zone_table','json')">JSON</button></li>
                                            <li><button class="dropdown-item" type="button" onclick="exportTableData('admin_zone_table','sql')">SQL</button></li>
                                            <li><button class="dropdown-item" type="button" onclick="exportTableData('admin_zone_table','excel')">Excel</button></li>
                                        </ul>
                                    </div>
                                </div>
                            </div>

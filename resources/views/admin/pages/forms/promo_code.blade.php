...
@section('content')
    <div class="d-flex row align-items-center">
        <div class="col-md-6 col-xl-6 page-info-title">
            <h3>{{ labels('admin_labels.promo_codes', 'PromoCode') }}</h3>
            <p class="sub_title">
                {{ labels('admin_labels.boost_sales_with_seamless_and_strategic_promocode_management', 'Boost Sales with Seamless and Strategic Promocode Management') }}
            </p>
        </div>
                    ...
                    <div class="card-body">
                        ...
                        <div class="row mt-2">
                            <div class="col-md-6 mb-3">
                                <label class="mb-2 mt-2"
                                    for="">{{ labels('admin_labels.title', 'Title') }}
                        ...
                        <div class="row mt-2">
                            <div class="col-md-12 mb-3">
                                <label class="mb-2 mt-2" for="">{{ labels('admin_labels.message', 'Message') }}
                                    <span class='text-asterisks text-sm'>*</span></label>
                            ...
                            <div class="col-md-6 mb-3">
                                <label class="mb-2 mt-2"
                                    ...
                                    <span class='text-asterisks text-sm'>*</span></label>
                                <input type="number" min=1 class="form-control" name="minimum_order_amount" value="">
                            </div>
                            <div class="col-md-6 mb-3">
                                <label class="mb-2 mt-2"

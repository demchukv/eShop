...
@section('content')
    ...
    <div class="d-flex row align-items-center">
        <div class="col-md-6 col-xl-6 page-info-title">
            <h3>{{ labels('admin_labels.time_slots', 'Time Slots') }}</h3>
            <p class="sub_title">
                    ...
                    <form id="" action="{{ route('time_slot.store') }}" class="submit_form"
                        ...
                        <div class="card-body">
                            ...
                            <div class="mb-3">
                                ...
                                <label for="" class="form-label">{{ labels('admin_labels.from_time', 'From Time') }}<span
                                        class="text-asterisks text-sm">*</span></label>
                            ...
                            <div class="mb-3">
                                ...
                                <label for="" class="form-label">{{ labels('admin_labels.to_time', 'To Time') }}<span
                                        class="text-asterisks text-sm">*</span></label>
                            ...
                            <div class="col-md-12 col-lg-6 d-flex justify-content-end">
                                ...
                                <div class="dropdown">
                                    ...
                                    <ul class="dropdown-menu" aria-labelledby="exportOptionsDropdown">
                                        <li><button class="dropdown-item" type="button" onclick="exportTableData('admin_time_slot_table','csv')">CSV</button></li>
                                        <li><button class="dropdown-item" type="button" onclick="exportTableData('admin_time_slot_table','json')">JSON</button></li>
                                        <li><button class="dropdown-item" type="button" onclick="exportTableData('admin_time_slot_table','sql')">SQL</button></li>
                                        <li><button class="dropdown-item" type="button" onclick="exportTableData('admin_time_slot_table','excel')">Excel</button></li>
                                    </ul>
                                </div>
                            </div>
                        </div>

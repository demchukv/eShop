...
@section('content')
    ...
    <div class="d-flex row align-items-center">
        <div class="col-md-6 col-xl-6 page-info-title">
            <h3>{{ labels('admin_labels.notification_and_contact', 'Notification & Contact') }}
            </h3>
            <p class="sub_title">
                    ...
                    <form id="" action="{{ route('notification_settings.store') }}" class="submit_form"
                        ...
                        <div class="form-group">
                            <div class="form-group mb-0">
                                <label for="firebase_project_id">{{ labels('admin_labels.firebase_project_id', 'Firebase Project ID') }}  </label>
                                <input type="text" id="firebase_project_id" class="form-control mt-2" name="firebase_project_id" placeholder='Firebase Project ID' value="<?= isset($firebase_project_id) ? outputEscaping($firebase_project_id) : '' ?>">
                            </div>
                        </div>
                        <div class="form-group mb-3">
                            ...
                            <input type="file" name="service_account_file" id="service_account_file" class="form-control mt-2" placeholder="Service Account File" accept=".json">
                        </div>
                        <div class="d-flex justify-content-end mt-4">
                            <button type="reset" class="btn mx-2 reset_button"
                                id="">{{ labels('admin_labels.reset', 'Reset') }}</button>

...
@section('content')
    <div class="d-flex row align-items-center">
        <div class="col-md-6 col-xl-6 page-info-title">
            <h3>{{ labels('admin_labels.storage_types', 'Storage Types') }}
                </th>
            </h3>
            <p class="sub_title">
                {{ labels('admin_labels.efficiently_organize_and_govern_storage_types', 'Efficiently Organize and Govern Storage Types') }}
            </p>
        </div>
            ...
            <nav aria-label="breadcrumb" class="float-end">
                <ol class="breadcrumb">
                    ...
                    <li class="breadcrumb-item second_breadcrumb_item">
                        {{ labels('admin_labels.media', 'Media') }}</li>
    ...
    <section class="overview-data">
        <div class="card content-area p-4 ">
                            ...
                            @if ( $user_role== 'super_admin' || $logged_in_user->hasPermissionTo('view storage_type'))
                                ...
                                <div class="dropdown">
                                    ...
                                    <ul class="dropdown-menu" aria-labelledby="exportOptionsDropdown">
                                        <li><button class="dropdown-item" type="button" onclick="exportTableData('admin_storage_type_table','csv')">CSV</button></li>
                                        <li><button class="dropdown-item" type="button" onclick="exportTableData('admin_storage_type_table','json')">JSON</button></li>
                                        <li><button class="dropdown-item" type="button" onclick="exportTableData('admin_storage_type_table','sql')">SQL</button></li>
                                        <li><button class="dropdown-item" type="button" onclick="exportTableData('admin_storage_type_table','excel')">Excel</button></li>
                                    </ul>
                                </div>
                            @endif
                        </div>
            ...
            <div class="row {{  $user_role== 'super_admin' || $logged_in_user->hasPermissionTo('view storage_type') ? '' : 'd-none' }}">
                <div class="col-md-12">
                    <div class="pt-0">

                ...
                <div class="col-md-12">
                    <div class="row">
                        ...
                        <div class="col-md-12 col-lg-6 d-flex justify-content-end ">
                                ...
                                <div class="input-group me-3 search-input-grp {{  $user_role== 'super_admin' || $logged_in_user->hasPermissionTo('view product_faq') ? '' : 'd-none' }}">
                                ...
                                <a class="btn me-2 {{  $user_role== 'super_admin' || $logged_in_user->hasPermissionTo('view combo_product_faq') ? '' : 'd-none' }}" id="tableFilter" data-bs-toggle="offcanvas"
                                    data-bs-target="#columnFilterOffcanvas" data-table="admin_product_faq_table"
                                    dateFilter='true' orderStatusFilter='false' paymentMethodFilter='false'
                                    orderTypeFilter='false'><i class='bx bx-filter-alt'></i></a>
                                <a class="btn me-2 {{  $user_role== 'super_admin' || $logged_in_user->hasPermissionTo('view combo_product_faq') ? '' : 'd-none' }}" id="tableRefresh" data-table="admin_product_faq_table"><i
                                ...
                                <div class="dropdown {{  $user_role== 'super_admin' || $logged_in_user->hasPermissionTo('view combo_product_faq') ? '' : 'd-none' }}">
                                    ...
                                    <ul class="dropdown-menu" aria-labelledby="exportOptionsDropdown">
                                        <li><button class="dropdown-item" type="button" onclick="exportTableData('admin_product_faq_table','csv')">CSV</button></li>
                                        <li><button class="dropdown-item" type="button" onclick="exportTableData('admin_product_faq_table','json')">JSON</button></li>
                                        <li><button class="dropdown-item" type="button" onclick="exportTableData('admin_product_faq_table','sql')">SQL</button></li>
                                        <li><button class="dropdown-item" type="button" onclick="exportTableData('admin_product_faq_table','excel')">Excel</button></li>
                                    </ul>
                                </div>
                        </div>
                    </div>

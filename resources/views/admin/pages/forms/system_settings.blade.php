...
@section('content')
    ...
    <div class="d-flex row align-items-center">
        <div class="col-md-6 col-xl-6 page-info-title">
            <h3>{{ labels('admin_labels.system_settings', 'System Settings') }}
            </h3>
            <p class="sub_title">
        ...
        <div class="col-md-4">
            <div class="card">
                <div class="tab-content p-4" id="pills-tabContent-vertical-pills">
                    <div class="tab-pane tab-example-design fade show active" id="pills-vertical-pills-design"
                        role="tabpanel" aria-labelledby="pills-vertical-pills-design-tab">
                        <div class="row">
                            ...
                            <div class="nav flex-column nav-pills p-2" id="v-pills-tab" role="tablist"
                                ...
                                <a class="nav-link border payment_method_title mt-2" id="" data-bs-toggle="pill"
                                    href="#cron_job" role="tab" aria-controls="v-pills-profile"
                                    aria-selected="false"
                                                                ...
                                                                <div class=''>
                                                                    <div class='upload-media-div'><img
                                                                            ...
                                                                            src="{{ route('admin.dynamic_image', [
                                                                                'url' => getMediaImageUrl($settings['logo']),
                                                                                'width' => 120,
                                                                                'quality' => 90,
                                                                            ]) }}"
                                                                            alt="Not Found"></div>
                                                        ...
                                                        <div
                                                            ...
                                                            <div class=''>
                                                                <div class='upload-media-div'><img class="img-fluid mb-2"
                                                                        src="{{ route('admin.dynamic_image', [
                                                                            'url' => getMediaImageUrl($settings['favicon']),
                                                                            'width' => 120,
                                                                            'quality' => 90,
                                                                        ]) }}"
                                                                        alt="Not Found"></div>
                                ...
                                <div class="card-body">
                                    ...
                                    <div class="row">
                                        ...
                                        <div class="row">
                                            <div class="mb-3 col-md-6">
                                                <label class="form-label"
                                                    for="basic-default-fullname">{{ labels('admin_labels.bot_user_name', 'Bot User Name') }}<span
                                                        class='text-asterisks text-sm'>*</span></label>
                                                <input type="text" class="form-control" id="basic-default-fullname"
                                                    placeholder="" name="tg_bot_user_name"
                                                    value="<?= isKeySetAndNotEmpty($settings, 'tg_bot_user_name') ? $settings['tg_bot_user_name'] : '' ?>">

                                            </div>
                                            <div class="mb-3 col-md-6">
                                                <label class="form-label"
                                                    for="basic-default-fullname">{{ labels('admin_labels.bot_token', 'Bot Token') }}<span
                                                        class='text-asterisks text-sm'>*</span></label>
                                                <input type="text" class="form-control" id="basic-default-fullname"
                                                    placeholder="" name="tg_bot_token"
                                                    value="<?= isKeySetAndNotEmpty($settings, 'tg_bot_token') ? $settings['tg_bot_token'] : '' ?>">
                                            </div>
                                        </div>
                                ...
                                <div class="card-body">
                                    <div class="row">
                                        ...
                                        <div class="col-md-4">
                                            <div class="form-check">
                                                <input class="form-check-input" type="radio"
                                                    name="authentication_method" value="telegram"
                                                    id="telegram_radio_button"
                                                    <?= $settings['authentication_method'] == 'telegram' ? 'checked' : '' ?>>
                                                <label class="form-check-label" for="telegram_radio_button">
                                    ...
                                    <div class="row">
                                        <div class="mb-3 col-md-6">
                                            ...
                                            <input type="text" disabled class="form-control"
                                                ...
                                                value="{{ config('app.url') . 'admin/cron-job/settle-seller-commission' }}">
                                        </div>
                                        ...
                                        <div class="mb-3 col-md-6">
                                            ...
                                            <input type="text" disabled class="form-control"
                                                ...
                                                value="{{ config('app.url') . 'admin/cron_job/settle_cashback_discount' }}">
                                        </div>

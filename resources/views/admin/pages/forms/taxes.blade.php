...
@section('content')
    <div class="d-flex row align-items-center">
        <div class="col-md-6 col-xl-6 page-info-title">
            <h3>{{ labels('admin_labels.taxes', 'Taxes') }}</h3>
            <p class="sub_title">
                {{ labels('admin_labels.masterful_tax_management_at_your_fingertips', 'Masterful Tax Management at Your Fingertips') }}
            </p>
        </div>
            ...
            <nav aria-label="breadcrumb" class="float-end">
                <ol class="breadcrumb">
                    ...
                    <li class="breadcrumb-item active" aria-current="page">
                        {{ labels('admin_labels.tax', 'Tax') }}</li>
                </ol>
            </nav>
        </div>
    </div>
    <div class="col-md-12">
        <div class="row">
                ...
                <div class="card">
                    ...
                    <form class="form-horizontal form-submit-event submit_form" action="{{ route('taxes.store') }}"
                        ...
                        <div class="card-body">
                            ...
                            <div class="mb-3 col-12">
                                <label for="" class="form-label">{{ labels('admin_labels.percentage', 'Percentage') }}<span
                                        class="text-asterisks text-sm">*</span></label>
            ...
            {{-- table --}}
            <div class="col-lg-8 col-md-12 col-sm-12 mt-md-2 mt-sm-2 mt-xl-0 mt-xxl-0 {{  $user_role== 'super_admin' || $logged_in_user->hasPermissionTo('view tax') ? '' : 'd-none' }}">
                                        ...
                                        <div class="col-sm-12 d-flex justify-content-end mt-md-0 mt-sm-2">
                                            ...
                                            <div class="dropdown">
                                                ...
                                                <ul class="dropdown-menu" aria-labelledby="exportOptionsDropdown">
                                                    <li><button class="dropdown-item" type="button" onclick="exportTableData('admin_tax_table','csv')">CSV</button></li>
                                                    <li><button class="dropdown-item" type="button" onclick="exportTableData('admin_tax_table','json')">JSON</button></li>
                                                    <li><button class="dropdown-item" type="button" onclick="exportTableData('admin_tax_table','sql')">SQL</button></li>
                                                    <li><button class="dropdown-item" type="button" onclick="exportTableData('admin_tax_table','excel')">Excel</button></li>
                                                </ul>
                                            </div>
                                        </div>
                                </div>
                                    ...
                                    <div class="pt-0">
                                        <div class="table-responsive">
                                            <table class='table' id="admin_tax_table" data-toggle="table"
                                                ...
                                                data-url="{{ route('taxes.list') }}" data-click-to-select="true"

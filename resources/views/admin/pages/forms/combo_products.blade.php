        ...
        <div class="col-xxl-12 p-0">
            <div class="row cols-5 d-flex">
                    ...
                    <div class="card p-5">
                        <div class="card1">
                            <ul id="progressbar" class="text-center">
                                ...
                                <li class="step0"></li>
                                <li class="step0"></li>
                                <li class="step0 combo_product_quantity_and_others"></li>
                                <li class="step0 combo_delivery_and_shipping_setting"></li>
                                <li class="step0"></li>
                                <li class="step0"></li>
                                <li class="step0"></li>
                            </ul>
                            ...
                            <h6 class="combo_product_quantity_and_others">
                                {{ labels('admin_labels.product_quantity_and_other', 'Product Quantity & Other') }}
                            </h6>
                            <h6 class="combo_delivery_and_shipping_setting">
                ...
                <div class="col-md-12 col-xl-9 mt-md-2 mt-sm-2 mt-xl-0">
                    <form action="{{ route('admin.combo_products.store') }}" class="submit_form"
                            ...
                            <div class="row">
                                <div class="col col-xxl-12">
                                    <div class="card p-5">
                                        ...
                                        <select class='form-control mt-4 combo_seller_id form-select' name='seller_id'
                                            id="seller_id">
                            ...
                            <div class="row">
                                <div class="col col-xxl-12">
                                    <div class="card p-5">
                                        ...
                                        <div class="row">
                                            <div class="form-group physical_product_in_combo col-md-12">
                                                <div class="mb-3 search_admin_product_for_combo_parent">
                                                    <label class="form-label"
                                                        for="name">{{ labels('admin_labels.products', 'Physical Products') }}<span
                                                            class='text-asterisks text-sm'>*</span></label>
                                                    <select id="" name="physical_product_variant_id[]"
                                                        value=""
                                                        class="select2 form-select  search_admin_product_for_combo w-100"
                                                        multiple>
                                                    </select>
                                                </div>
                                            </div>
                                            <div class="form-group digital_product_in_combo col-md-12 d-none">
                                                <div class="mb-3">
                                                    <label class="form-label"
                                                        for="name">{{ labels('admin_labels.products', 'Digital Products') }}<span
                                                            class='text-asterisks text-sm'>*</span></label>
                                        ...
                                        <div class="row">
                                            <div class="form-group col-md-4">
                                                <div class="d-flex justify-content-between align-items-center">
                                                    <label for="tags"
                                                        class="form-label">{{ labels('admin_labels.has_similar_products', 'Has similar products') }}?</label>
                                            ...
                                            <div class="col-md-12 col-xs-12 d-none" id='similar_product'>
                        ...
                        <div class="card2 ml-2 combo_product_quantity_and_others">
                            <div class="row">
                                <div class="col col-xxl-12">
                                    <div class="card p-5">
                                            ...
                                            <div class="col-md-6 total_allowed_quantity">
                                                <div class="form-group">
                                                    ...
                                                    <input type="number" class="col-md-12 form-control"
                                                        name="total_allowed_quantity" value="" min=1
                        ...
                        <div class="card2 ml-2 combo_delivery_and_shipping_setting">
                            <div class="row">
                                <div class="col col-xxl-12">
                                    <div class="card p-5">
                                        ...
                                        <div class="row">
                                            <div class="col-md-6 ">
                                                <div class="form-group">
                                                    ...
                                                    <select class="form-select form-select" name="deliverable_type"
                                                        id="deliverable_type">

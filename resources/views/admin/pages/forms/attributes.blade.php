...
@section('content')
    ...
    <div class="col-md-12">
        <div class="row">
            ...
            {{-- table  --}}
            <div class="col-lg-8 col-md-12 mt-md-2 mt-sm-2 {{ $user_role== 'super_admin' || $logged_in_user->hasPermissionTo('view attributes') ? '' : 'd-none' }}">
                                        ...
                                        <div class="col-sm-12 d-flex justify-content-end mt-md-0 mt-sm-2">
                                            ...
                                            <div class="dropdown">
                                                ...
                                                <ul class="dropdown-menu" aria-labelledby="exportOptionsDropdown">
                                                    <li><button class="dropdown-item" type="button" onclick="exportTableData('admin_attribute_table','csv')">CSV</button></li>
                                                    <li><button class="dropdown-item" type="button" onclick="exportTableData('admin_attribute_table','json')">JSON</button></li>
                                                    <li><button class="dropdown-item" type="button" onclick="exportTableData('admin_attribute_table','sql')">SQL</button></li>
                                                    <li><button class="dropdown-item" type="button" onclick="exportTableData('admin_attribute_table','excel')">Excel</button></li>
                                                </ul>
                                            </div>
                                        </div>
                                    ...
                                    <div class="pt-0">
                                        <div class="table-responsive">
                                            <table class='table' id="admin_attribute_table" data-toggle="table"
                                                ...
                                                data-url="{{ route('admin.attributes.list') }}"

...
@section('content')
    <div class="d-flex row align-items-center">
        <div class="col-md-6 col-xl-6 page-info-title">
            <h3>{{ labels('admin_labels.brands', 'Brands') }}
            </h3>
            <p class="sub_title">
        ...
        <div class="row">
            <div class="col-md-12 col-xl-4">
                <div class="card">
                    ...
                    <form id="" action="{{ route('brands.store') }}" class="submit_form"
                        ...
                        <div class="card-body pt-0">
                            <div class="mb-3">
                                ...
                                <input type="text" name="brand_name" class="form-control" placeholder="Brands">
                            </div>
            ...
            {{-- table  --}}
            <div class="col-md-12 col-xl-8 mt-xl-0 mt-md-2 {{ $user_role == 'super_admin' || $logged_in_user->hasPermissionTo('view brands') ? '' : 'd-none' }}">
                                    ...
                                    <div class="col-sm-12 d-flex justify-content-end mt-md-0 mt-sm-2">
                                        ...
                                        <div class="dropdown">
                                            ...
                                            <ul class="dropdown-menu" aria-labelledby="exportOptionsDropdown">
                                                <li><button class="dropdown-item" type="button" onclick="exportTableData('admin_brand_table','csv')">CSV</button></li>
                                                <li><button class="dropdown-item" type="button" onclick="exportTableData('admin_brand_table','json')">JSON</button></li>
                                                <li><button class="dropdown-item" type="button" onclick="exportTableData('admin_brand_table','sql')">SQL</button></li>
                                                <li><button class="dropdown-item" type="button" onclick="exportTableData('admin_brand_table','excel')">Excel</button></li>
                                            </ul>
                                        </div>
                                    </div>

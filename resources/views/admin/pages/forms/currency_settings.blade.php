...
@section('content')
    ...
    <div class="d-flex row align-items-center">
        <div class="col-md-6 col-xl-6 page-info-title">
            <h3>{{ labels('admin_labels.currency_setting', 'Currency Setting') }}
            </h3>
            <p class="sub_title">
                            ...
                            <div class="col-md-12">
                                <div class="form-group mb-2">
                                    <select class="form-control default_currency select2" name="currency_id">
                                        ...
                                        @php
                                            $selected = (isset($currency) && !empty($currency) && $currency->is_default == 1) ? 'selected' : '';
                                        @endphp
                                                    ...
                                                    <div class="modal-body">
                                                        ...
                                                        <p>4. Click on that, and you will be able to see the app ID. Copy
                                                            ...
                                                            <div class="currency_api_details">
                                                                <img alt="" src="{{ getimageurl('system_images/currency_api_details.png') }}" />
                                                            </div>
                                                    </div>
                            ...
                            <div class="col-md-12 col-lg-6 d-flex justify-content-end">
                                ...
                                <div class="dropdown">
                                    ...
                                    <ul class="dropdown-menu" aria-labelledby="exportOptionsDropdown">
                                        <li><button class="dropdown-item" type="button" onclick="exportTableData('admin_currency_table','csv')">CSV</button></li>
                                        <li><button class="dropdown-item" type="button" onclick="exportTableData('admin_currency_table','json')">JSON</button></li>
                                        <li><button class="dropdown-item" type="button" onclick="exportTableData('admin_currency_table','sql')">SQL</button></li>
                                        <li><button class="dropdown-item" type="button" onclick="exportTableData('admin_currency_table','excel')">Excel</button></li>
                                    </ul>
                                </div>
                            </div>
                        </div>

...
@section('content')
    ...
    <div class="d-flex row align-items-center">
        <div class="col-md-6 col-xl-6 page-info-title">
            <h3>{{ labels('admin_labels.general_settings', 'General Settings') }}
            </h3>
            <p class="sub_title">
                {{ labels('admin_labels.customoize_your_platform_with_essential_general_settings', 'Customize Your Platform with Essential General Settings') }}
            </p>
        </div>

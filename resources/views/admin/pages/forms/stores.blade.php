...
@section('content')
    <div class="d-flex align-items-center">
        <div class="col-md-6 col-xl-6 page-info-title">
            <h3>{{ labels('admin_labels.add_store', 'Add Store') }}</h3>
            <p class="sub_title">
                {{ labels('admin_labels.lets_unlesh_a_wave_of_new_stores_on_your_marketplace', 'Lets unleash a wave of new stores on your marketplace.') }}
            </p>
        </div>
            ...
            <div class="col-md-12 col-xl-3 col-xxl-3">
                <div class="card p-5">
                    <div class="card1">
                        ...
                        <h6>{{ labels('admin_labels.app_settings', 'App Setting') }}</h6>
                        ...
                        <h6>{{ labels('admin_labels.brands_display_style', 'Brands Display Style') }}</h6>
                                    ...
                                    <div class="row mt-4">
                                        <div class="mb-3 col-md-12">
                                            ...
                                            <input type="text" class="form-control" id="basic-default-fullname"
                                                placeholder="Electronics Store" name="name" value="{{ old('name') }}">
                                        ...
                                        <div class="mb-3 col-md-12">
                                            ...
                                            <textarea name="description" class="form-control" placeholder="Write here your description">{{ old('description') }}</textarea>
                                        </div>
                                    </div>
                                    <div class="row mb-3">
                                        <div class="col-md-6">
                                ...
                                <div class="card p-5">
                                    ...
                                    <div class="form-group col-md-12 mb-4">
                                        <div class="row form-group">
                                            <div class="col-md-6">
                                                <label for="image"
                                                    class="mb-2">{{ labels('admin_labels.banner_image_for_most_selling_products', 'Banner Image (For Most Selling Products)') }}
                                                    <span class='text-asterisks text-sm'>*</span>
                                                </label>
                                        ...
                                        <div class="row form-group">
                                            ...
                                            <div class="col-md-6">
                                                <label for="image"
                                                    class="mb-2">{{ labels('admin_labels.half_store_logo', 'Half Store Logo (try to upload square image)') }}
                                                    <span class='text-asterisks text-sm'>*</span>
                                                </label>

...
@section('content')
    <div class="d-flex row align-items-center">
        <div class="col-md-6 col-xl-6 page-info-title">
            <h3>{{ labels('admin_labels.product_faqs', 'Product FAQs') }}</h3>
            <p class="sub_title">
                {{ labels('admin_labels.empower_customers_with_clear_and_insightful_product_faqs', 'Empower Customers with Clear and Insightful Product FAQs') }}
            </p>
        </div>
            ...
            <nav aria-label="breadcrumb" class="float-end">
                <ol class="breadcrumb">
                    ...
                    <li class="breadcrumb-item">
                        {{ labels('admin_labels.products', 'Products') }}</li>
    ...
    <section class="overview-data">
        <div class="card content-area p-4 ">
            <div class="row align-items-center d-flex heading mb-5">
                <div class="col-md-12">
                    <div class="row">
                        ...
                        <div class="col-md-12 col-sm-12 d-flex justify-content-end mt-md-0 mt-sm-2">
                                ...
                                <div class="input-group me-2 search-input-grp {{ $user_role== 'super_admin' || $logged_in_user->hasPermissionTo('view combo_product_faq') ? '' : 'd-none' }}">
                                    <span class="search-icon"><i class='bx bx-search-alt'></i></span>
                                    <input type="text" data-table="admin_combo_product_faq_table"
                                        class="form-control searchInput" placeholder="Search...">
                                    <span class="input-group-text">{{ labels('admin_labels.search', 'Search') }}</span>
                                </div>
                                <a class="btn me-2 {{  $user_role== 'super_admin' || $logged_in_user->hasPermissionTo('view combo_product_faq') ? '' : 'd-none' }}" id="tableFilter" data-bs-toggle="offcanvas"
                                    data-bs-target="#columnFilterOffcanvas" data-table="admin_combo_product_faq_table"
                                    dateFilter='false' orderStatusFilter='false' paymentMethodFilter='false'
                                    orderTypeFilter='false'><i class='bx bx-filter-alt'></i></a>
                                <a class="btn me-2 {{  $user_role== 'super_admin' || $logged_in_user->hasPermissionTo('view combo_product_faq') ? '' : 'd-none' }}" id="tableRefresh"data-table="admin_combo_product_faq_table"><i
                                        class='bx bx-refresh'></i></a>
                                <div class="dropdown {{  $user_role== 'super_admin' || $logged_in_user->hasPermissionTo('view combo_product_faq') ? '' : 'd-none' }}">
                                    <a class="btn dropdown-toggle export-btn" type="button" id="exportOptionsDropdown"
                                        data-bs-toggle="dropdown" aria-expanded="false">
                                        <i class='bx bx-download'></i>
                                    </a>
                                    <ul class="dropdown-menu" aria-labelledby="exportOptionsDropdown">
                                        <li><button class="dropdown-item" type="button" onclick="exportTableData('admin_combo_product_faq_table','csv')">CSV</button></li>
                                        <li><button class="dropdown-item" type="button" onclick="exportTableData('admin_combo_product_faq_table','json')">JSON</button></li>
                                        <li><button class="dropdown-item" type="button" onclick="exportTableData('admin_combo_product_faq_table','sql')">SQL</button></li>
                                        <li><button class="dropdown-item" type="button" onclick="exportTableData('admin_combo_product_faq_table','excel')">Excel</button></li>
                                    </ul>
                                </div>
                        </div>
                    </div>
                ...
                <div class="row {{  $user_role== 'super_admin' || $logged_in_user->hasPermissionTo('view combo_product_faq') ? '' : 'd-none' }}">
                    <div class="col-md-6">

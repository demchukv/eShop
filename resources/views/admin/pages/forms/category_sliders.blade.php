                            ...
                            <div class="form-group">
                                <form id="" action="{{ route('category_sliders.store') }}" class="submit_form"
                                    ...
                                    <div class="row">
                                        <div class="mb-3">
                                            ...
                                            <input type="text" class="form-control" id="basic-default-fullname"
                                                placeholder="Popular Categories" name="title" value="{{ old('title') }}">
                                    ...
                                    <div class="category_slider_style_images category_card_style_box">
                                        <img src="{{ getimageurl('system_images/category_slider_style_1.png') }}" alt="" class="style_1" />
                                        <img src="{{ getimageurl('system_images/category_slider_style_2.png') }}" alt="" class="style_2" />
                                ...
                                <div class="col-md-12 col-lg-6 d-flex justify-content-end mt-md-0 mt-sm-2">
                                    ...
                                    <div class="dropdown">
                                        ...
                                        <ul class="dropdown-menu" aria-labelledby="exportOptionsDropdown">
                                            <li><button class="dropdown-item" type="button" onclick="exportTableData('admin_category_slider_table','csv')">CSV</button></li>
                                            <li><button class="dropdown-item" type="button" onclick="exportTableData('admin_category_slider_table','json')">JSON</button></li>
                                            <li><button class="dropdown-item" type="button" onclick="exportTableData('admin_category_slider_table','sql')">SQL</button></li>
                                            <li><button class="dropdown-item" type="button" onclick="exportTableData('admin_category_slider_table','excel')">Excel</button></li>
                                        </ul>

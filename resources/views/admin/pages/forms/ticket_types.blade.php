...
@section('content')
    <div class="d-flex row align-items-center">
        <div class="col-md-6 col-xl-6 page-info-title">
            <h3>{{ labels('admin_labels.support_ticket', 'Support Ticket') }}
            </h3>
            <p class="sub_title">
                {{ labels('admin_labels.effortlessly_organize_and_categorize_support_tickets', 'Effortlessly Organize and Categorize Support Tickets') }}
            </p>
        </div>
            ...
            <nav aria-label="breadcrumb" class="float-end">
                <ol class="breadcrumb">
                    ...
                    <li class="breadcrumb-item second_breadcrumb_item">
                        {{ labels('admin_labels.support_ticket', 'Support Ticket') }}
                    </li>
    ...
    <div class="col-md-12">
        <div class="row">
            <div class="col-md-12 col-lg-4">
                <div class="card">
                    <div class="card-body">
                        ...
                        <div class="row mt-2">
                            <form class="form-horizontal submit_form" action="{{ route('ticket_types.store') }}"
            ...
            <div class="col-lg-8 col-md-12 mt-md-2 mt-sm-2 {{  $user_role== 'super_admin' || $logged_in_user->hasPermissionTo('view tickets') ? '' : 'd-none' }}">
                                ...
                                <div class="row">
                                    <div class="col-sm-12">
                                        ...
                                        <div class="col-sm-12 d-flex justify-content-end mt-md-0 mt-sm-2">
                                            ...
                                            <a class="btn me-2"
                                                id="tableRefresh"data-table="admin_support_ticket_type_table"><i
                                            ...
                                            <div class="dropdown">
                                                ...
                                                <ul class="dropdown-menu" aria-labelledby="exportOptionsDropdown">
                                                    <li><button class="dropdown-item" type="button" onclick="exportTableData('admin_support_ticket_type_table','csv')">CSV</button></li>
                                                    <li><button class="dropdown-item" type="button" onclick="exportTableData('admin_support_ticket_type_table','json')">JSON</button></li>
                                                    <li><button class="dropdown-item" type="button" onclick="exportTableData('admin_support_ticket_type_table','sql')">SQL</button></li>
                                                    <li><button class="dropdown-item" type="button" onclick="exportTableData('admin_support_ticket_type_table','excel')">Excel</button></li>
                                                </ul>
                                            </div>
                                        </div>
                                </div>

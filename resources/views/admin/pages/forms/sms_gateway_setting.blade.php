...
@section('content')
    <div class="d-flex row align-items-center">
        <div class="col-md-6 col-xl-6 page-info-title">
            <h3>{{ labels('admin_labels.sms_gateway_setting', 'SMS Gateway Setting') }}</h3>
            <p class="sub_title">
                {{ labels('admin_labels.seamlessly_integrate_and_leverage_sms_capabilities', 'Seamlessly Integrate and Leverage SMS Capabilities') }}
            </p>
        </div>
            ...
            <nav aria-label="breadcrumb" class="float-end">
                <ol class="breadcrumb">
                    ...
                    <li class="breadcrumb-item active" aria-current="page">
                        {{ labels('admin_labels.sms_gateway_setting', 'SMS Gateway Setting') }}</li>
                </ol>
            </nav>
        </div>
    </div>
                                    ...
                                    <ul class="nav nav-tabs mb-4">
                                        ...
                                        <li class="nav-item">
                                            <a class="nav-link sms_gateway_nav_link sms_gateway_tab"
                                                id="product-params-tab" data-bs-toggle="tab" href="#product-params"
                                                role="tab" aria-controls="product-params"
                                                aria-selected="false">Params</a>
                                        </li>
                                    </ul>
                                    <div class="tab-content" id="nav-tabContent">
                                        <!-- header -->

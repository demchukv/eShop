...
@section('content')
    ...
    <div class="d-flex row align-items-center">
        <div class="col-md-6 col-xl-6 page-info-title">
            <h3>{{ labels('admin_labels.admin_and_seller_policies', 'Admin & Seller Policies') }}
            </h3>
            <p class="sub_title">
                {{ labels('admin_labels.administor_policies_for_seamless_operations', 'Govern with Clarity - Administer Policies for Seamless Operations') }}
            </p>
        </div>

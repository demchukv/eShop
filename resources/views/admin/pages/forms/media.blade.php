...
@section('content')
    <div class="d-flex row align-items-center">
        <div class="col-md-6 col-xl-6 page-info-title">
            <div class="col-md-6 col-xl-6 page-info-title">
                <h3>{{ labels('admin_labels.media', 'Media') }}</h3>
                <p class="sub_title">{{ labels('admin_labels.take_command_of_your_media', 'Take Command Of Your Media') }}
                </p>
            </div>
        </div>
        <div class="col-md-6">
            <nav aria-label="breadcrumb" class="float-end">
                <ol class="breadcrumb">
                    ...
                    <li class="breadcrumb-item">{{ labels('admin_labels.media_management', 'Media Management') }}</li>
                    <li class="breadcrumb-item active">{{ labels('admin_labels.add_media', 'Add Media') }}</li>
                </ol>
            </nav>
        </div>
    </div>

...
@section('content')
    <div class="d-flex row align-items-center">
        <div class="col-md-6 col-xl-6 page-info-title">
            <h3>{{ labels('admin_labels.view_product', 'View Product') }}</h3>
            <p class="sub_title">
                {{ labels('admin_labels.view_product_details_and_analytics', 'View Product Details & Analytics') }}
            </p>
        </div>

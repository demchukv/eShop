    ...
    <div class="modal fade" id="send_withdrawal_request" tabindex="-1" role="dialog"
        ...
        <div class="modal-dialog  modal-lg modal-dialog-centered" role="document">
            <div class="modal-content">
                <form class="submit_form" method="POST" action="{{ route('delivery_boy.payment_request.add_withdrawal_request') }}"
                            ...
                            <div class="col-md-12 col-xxl-6 d-flex justify-content-end ">
                                ...
                                <div class="dropdown">
                                    ...
                                    <ul class="dropdown-menu" aria-labelledby="exportOptionsDropdown">
                                        <li><button class="dropdown-item" type="button" onclick="exportTableData('delivery_boy_customer_wallet_table','csv')">CSV</button></li>
                                        <li><button class="dropdown-item" type="button" onclick="exportTableData('delivery_boy_customer_wallet_table','json')">JSON</button></li>
                                        <li><button class="dropdown-item" type="button" onclick="exportTableData('delivery_boy_customer_wallet_table','sql')">SQL</button></li>
                                        <li><button class="dropdown-item" type="button" onclick="exportTableData('delivery_boy_customer_wallet_table','excel')">Excel</button></li>
                                    </ul>
                                </div>
                            </div>
                    </div>

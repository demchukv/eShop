...
<div class="offcanvas offcanvas-end" tabindex="-1" id="filtersOffcanvas">
    ...
    <div class="container-fluid table-filter-section mb-8">
        ...
        <div class="returnReasonFilter mt-5 d-none">
            <label for="reason"
                class="form-label body-default">{{ labels('admin_labels.reason', 'Reason') }}</label>
            <select class="form-select" name="reason" id="reason">
                <option value="">{{ labels('admin_labels.all', 'All') }}</option>

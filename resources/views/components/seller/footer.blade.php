                            ...
                            <div class="card-body">
                                ...
                                <div class="row">
                                    <div class="col-md-12 mt-3 mb-5">
                                        <form action="{{ route('seller.media.upload') }}" class="media_submit_form" enctype="multipart/form-data" method="POST">
                                            @csrf
                                            <input type="file" class="filepond" name="documents[]" multiple data-max-file-size="30MB" data-max-files="20" />
                                            <button type="submit" class="btn btn-primary float-end mt-3">{{ labels('admin_labels.upload', 'Upload') }}</button>
                                        </form>
                                    </div>
                                </div>
                                ...
                                <div class="row align-items-center d-flex heading mb-5">
                                    ...
                                    <div class="col-md-6 d-flex justify-content-end ">
                                        <div class="input-group me-3 search-input-grp ">
                                            ...
                                            <input type="text" data-table="media-upload-table" class="form-control searchInput" placeholder="Search...">
                                            <span class="input-group-text">{{ labels('admin_labels.search', 'Search') }}</span>
                                        </div>
                                        <a class="btn me-3" id="tableRefresh" data-table="media-upload-table"><i class='bx bx-refresh'></i></a>
                                        <div class="dropdown">
                                            ...
                                            <ul class="dropdown-menu" aria-labelledby="exportOptionsDropdown">
                                                <li><button class="dropdown-item" type="button" onclick="exportTableData('media-upload-table','csv')">CSV</button></li>
                                                <li><button class="dropdown-item" type="button" onclick="exportTableData('media-upload-table','json')">JSON</button></li>
                                                <li><button class="dropdown-item" type="button" onclick="exportTableData('media-upload-table','sql')">SQL</button></li>
                                                <li><button class="dropdown-item" type="button" onclick="exportTableData('media-upload-table','excel')">Excel</button></li>
                                            </ul>
                                        </div>
                                    </div>
                                </div>
                                <div class="mt-3">
                                    <table class="table table-striped" data-toolbar="#toolbar" id="media-upload-table" data-page-size="5" data-toggle="table" data-url="{{ route('admin.media.list') }}" data-click-to-select="true" data-side-pagination="server" data-pagination="true" data-page-list="[5, 10, 20, 50, 100, 200]" data-search="false" data-show-columns="false" data-show-refresh="false" data-trim-on-search="false" data-sort-name="id" data-sort-order="desc" data-mobile-responsive="true" data-show-export="false" data-query-params="mediaParams">
                                        <thead>
                                            <tr>
                                                <th data-field="state" data-checkbox="true"></th>
                                                <th data-field="id" data-sortable="true" data-visible="true">ID</th>
                                                <th class="d-flex justify-content-center" data-field="image" data-sortable="false">Image</th>
                                                ...
                                                <th data-field="extension" data-sortable="false" data-visible="true">
                                                    Extension</th>
                                                <th data-field="sub_directory" data-sortable="false" data-visible="true">
                                                    Sub directory</th>
...
<div class="offcanvas offcanvas-end" tabindex="-1" id="filtersOffcanvas">
    ...
    <div class="container-fluid table-filter-section mb-8">
        ...
        <div class="dateRangeFilter d-none mt-5">
            <label for="" class="form-label body-default">{{ labels('admin_labels.date_range', 'Date Range') }}</label>
            <div id="datepicker">
        ...
        <div class="orderStatusFilter mt-5 d-none">
            <label for="" class="form-label body-default">{{ labels('admin_labels.select_status', 'Select Status') }}</label>
        ...
        <div class="paymentMethodFilter mt-5 d-none">
            <label for="" class="form-label body-default">{{ labels('admin_labels.payment_method', 'Payment Method') }}</label>
            <select id="payment_method" name="payment_method" placeholder="Select Payment Method" class="form-control">
        ...
        <div class="orderTypeFilter mt-5 d-none">
            <label for="" class="form-label body-default">{{ labels('admin_labels.order_type', 'Order Type') }}</label>
        ...
        <div class="categoryFilter mt-5 d-none ">
            <label for="" class="form-label body-default">{{ labels('admin_labels.select_category', 'Select Category') }}</label>
        ...
        <div class="productStatusFilter mt-5 d-none ">
            <label for="" class="form-label body-default">{{ labels('admin_labels.product_status', 'Product Status') }}</label>
        ...
        <div class="productTypeFilter mt-5 d-none ">
            <label for="" class="form-label body-default">{{ labels('admin_labels.product_type', 'Product Type') }}</label>
        ...
        <div class="brandFilter mt-5 d-none ">
            <label for="" class="form-label body-default">{{ labels('admin_labels.select_brand', 'Select Brand') }}</label>
            <select class="form-select admin_brand_list" id="admin_brand_list" name="brand">
            </select>
        </div>

        <div class="paymentRequestStatusFilter mt-5 d-none ">
            <label for="" class="form-label body-default">{{ labels('admin_labels.payment_request_status', 'Payment Request Status') }}</label>
    ...
    <div class="d-flex justify-content-end mb-3 pe-3">
        <button type="reset" class="btn reset-btn reset_filter_button me-3">{{ labels('admin_labels.reset_filter', 'Reset Filter') }}</button>
        <button type="button" class="btn form-btn" id="tableFilterBtn">{{ labels('admin_labels.apply_filter', 'Apply Filter') }}</button>
    </div>
</div>
                ...
                <div class="row">
                    <div class="col-md-6">
                        <span class="copyright">
                            Copyright © 2025 <a href="https://eshop-pro-dev.eshopweb.store/admin/home">eShop Pro.</a>
                            All
                            rights reserved.
                        </span>
                    </div>
                    <div class="col-md-6 text-end">
                        <span class="text-end text-muted">
                            <span class="badge bg-primary footer-version-badge d-inline">V. {{ get_current_version() }}</span>
                        </span>
                    </div>
                </div>
            </div>

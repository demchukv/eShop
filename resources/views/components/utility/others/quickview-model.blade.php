                                ...
                                <div class="d-flex-center fs-5 fw-500 mb-10px">
                                    @if ($product[0]->type == 'combo-product')
                                        <span class="price product_price" id="price">
                                            {{ currentCurrencyPrice($product[0]->special_price, true) }}</span>
                                    @else
                                        <span class="price product_price" id="price">
                                            {{ $product[0]->type != 'variable_product' ? currentCurrencyPrice($product[0]->variants[0]->special_price, true) : currentCurrencyPrice($product[0]->min_max_price['max_price'], true) . '-' . currentCurrencyPrice($product[0]->min_max_price['special_min_price'], true) }}</span>
                                    @endif
                                </div>
                                @php
                                ...
                                @if ($this->product_type != 'combo-product')
                                    @if (!empty($product[0]->brand_name))
                                        <a wire:navigate
                                            ...
                                            class="text-ellipsis mb-10px" title="{!! $product[0]->brand_name !!}"><ion-icon
                                                class="custom-icon fs-6 me-1"
                                                name="medal-outline"></ion-icon>{!! $product[0]->brand_name !!}
                                        </a>
                                    @endif
                                    <a wire:navigate
                                        href="{{ customUrl('categories/' . $category[0]->slug . '/products') }}"
                                        class="text-ellipsis mb-10px text-secondary"
                                        title="{!! $product[0]->category_name !!}"><ion-icon name="layers-outline"
                                            class="custom-icon fs-6 me-1"></ion-icon>{!! $product[0]->category_name !!}
                                    </a>
                                @endif
                                <hr class="light-hr" />
                                    ...
                                    <div class="product-action d-flex-wrap w-100 pt-1 mb-3 clearfix">
                                        ...
                                        <div class="addtocart ms-3 fl-1">
                                            <button type="submit" name="add"
                                                ...
                                                data-brand-name='{{ $product[0]->brand_name ?? '' }}'

        ...
        <div class="row">
            ...
            <div class="col-12 col-sm-12 col-md-12 {{ $showFilter == true ? 'col-lg-9' : '' }}  main-col">
                ...
                @if (count($sub_categories) >= 1)
                    <x-utility.categories.subCategories.subCategoriesSection :$sub_categories />
                @endif
                ...
                @else
                    ...
                    <div class="grid-products grid-view-items mb-4">
                        <div
                            class="row col-row product-options {{ $view_mode == 'list' ? 'list-style' : 'row-cols-lg-4 row-cols-md-3 row-cols-sm-3 row-cols-2' }} ">

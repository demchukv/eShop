                                            ...
                                            <div
                                                ...
                                                <div class="rte rte-setting mb-4 pb-md-2">
                                                    <p class="text-medium"><br><b>{{ $offers['min_discount'] }} TO
                                                            {{ $offers['max_discount'] }}%
                                                            {{ labels('front_messages.discount', 'DISCOUNT') }}</b></p>
                                                </div>
                                            ...
                                            <a href="{{ $data->link }}"
                                                ...
                                                <div class="img img-box-h300px">
                                                    <img class="blur-up lazyload w-100"
                                                        ...
                                                        src="{{ $singleOffersImage }}" alt="collection"
                                                        title="" />
                                                </div>
                                                <div class="details middle-center text-center p-md-2 w-100">
                                                    <div class="inner">
                                                        ...
                                                        <span class="btn btn-secondary btn-md  mt-3 xs-hide">{{ labels('front_messages.shop_now', 'Shop Now') }}</span>
                                                    </div>
                                                </div>
                                            </a>
                                        </div>

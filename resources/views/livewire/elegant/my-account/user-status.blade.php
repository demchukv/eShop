...
<div>
                                            ...
                                            <div class="modal-content">
                                                <div class="modal-header">
                                                    <h2 class="modal-title" id="dealerModalLabel">
                                                        {{ labels('front_messages.become_dealer', 'Become a dealer') }}
                                                    </h2>
                                                        ...
                                                        <div
                                                            ...
                                                            <div class="form-group" wire:ignore>
                                                                ...
                                                                <input name="last_name" placeholder="Last Name"
                                                                    value="{{ $user_info->last_name }}" id="last_name"
                                                                    type="text" />
                                                            </div>
                                                            <div class="form-group">
                                                                <label for="birthdate"
                                                                    class="">{{ labels('front_messages.birthdate', 'Birthdate') }}</label>
                                                                <input wire:model="dealer_birthdate" type="text"
                                                                    class="form-control datepicker"
                                                                    name="dealer_birthdate" id="dealer_birthdate"
                                                            ...
                                                            <div class="form-group">
                                                                <label for="message"
                                                                    class="">{{ labels('front_messages.your_comments', 'Your comments') }}</label>
                                            ...
                                            <div class="modal-content">
                                                <div class="modal-header">
                                                    <h2 class="modal-title" id="managerModalLabel">
                                                        {{ labels('front_messages.become_manager', 'Become a Manager') }}
                                                    </h2>
                                                    <button type="button" class="btn-close" data-bs-dismiss="modal"
                                                        aria-label="Close"></button>
                                                </div>
                                                    ...
                                                    <form wire:submit="send_manager_request" action="">
                                                        <div
                                                            ...
                                                            <div class="form-group">
                                                                <label for="first_name"
                                                                    class="">{{ labels('front_messages.first_name', 'First Name') }}</label>
                                                                <input wire:model="first_name" name="first_name"
                                                            ...
                                                            <div class="form-group">
                                                                <label for="last_name"
                                                                    class="">{{ labels('front_messages.last_name', 'Last Name') }}</label>
                                                                <input wire:model="last_name" name="last_name"
                                                            ...
                                                            <div class="form-group">
                                                                <label for="birthdate"
                                                                    class="">{{ labels('front_messages.birthdate', 'Birthdate') }}</label>
                                                                <input wire:model="manager_birthdate" type="text"
                                                                    class="form-control datepicker"
                                                                    name="manager_birthdate" id="manager_birthdate"
                                                            ...
                                                            <div class="form-group">
                                                                <label for="passport"
                                                                    class="">{{ labels('front_messages.passport', 'Passport') }}</label>
                                                                <input wire:model="passport" type="text"
                                                            ...
                                                            <div class="form-group">
                                                                <label for="tax_id"
                                                                    class="">{{ labels('front_messages.tax_id', 'Tax ID') }}</label>
                                                                <input wire:model="tax_id" type="text"
                                                                    class="form-control" name="tax_id"
                                                                    id="tax_id" placeholder="Enter your tax ID" />
                                                                @error('tax_id')
                                                                    <span class="error_msg">{{ $message }} </span>
                                                                @enderror
                                                            </div>
                                                            <div class="form-group">
                                                                <label for="photos"
                                                                    class="">{{ labels('front_messages.photo', 'Photos of documents') }}</label>
                                                                ...
                                                                <input wire:model.live="newPhotos" type="file"
                                ...
                                @if ($user_status)
                                    <div class="row">
                                        <div class="col-12">
                                            ...
                                            <p>New role: <span
                                                    class="badge bg-primary">{{ $user_status->type }}</span></p>
                                            <p>Request status: <span
                                                    class="badge bg-secondary">{{ $user_status->status }}</span></p>
                                                    ...
                                                    <div>
                                                        ...
                                                        <div class="d-flex flex-wrap gap-2">
                                                            @foreach ((array) $user_status->photos as $photo)
                                                                <div class="position-relative">
                                                                    <img class="img-thumbnail cursor-pointer preview-photo"
                                                                        width="100" height="100"
                                                ...
                                                <table class="table">
                                                    <thead>
                                                        <tr>
                                                            ...
                                                            <th>{{ labels('front_messages.documents', 'Documents') }}
                                                            </th>
                                                            <th>{{ labels('front_messages.notes', 'Notes') }}</th>
                                                            <th>{{ labels('front_messages.created_at', 'Created At') }}
                                                            </th>
                                                        </tr>
                                                    </thead>
                                                    <tbody>
                                                        @foreach ($archived_requests as $request)
                                                            <tr>
                                                                ...
                                                                <td>
                                                                    <span
                                                                        class="badge bg-{{ $request->status === 'approved' ? 'success' : 'danger' }}">
                                                                ...
                                                                <td>
                                                                    ...
                                                                    @else
                                                                        <span
                                                                            class="text-muted">{{ labels('front_messages.no_documents', 'No documents') }}</span>
                                                                    @endif
                                                                </td>
                                                                <td>{{ $request->notes ?? '-' }}</td>
                                                                <td>{{ $request->created_at->format('Y-m-d H:i:s') }}
                                                                </td>
                                                            </tr>
                                                        @endforeach
                                                    </tbody>
    ...
    <div wire:ignore class="modal fade" id="photoPreviewModal" tabindex="-1"

                        ...
                        <div class="h-100" id="info">
                            <div class="account-info h-100">
                                <div class="welcome-msg mb-4">
                                    ...
                                    <p>{{ labels('front_messages.my_account_dashboard', 'From your My Account Dashboard') }}
                                        {{ labels('front_messages.view_snapshot', 'you have the ability to view a snapshot of your recent account activity') }}
                                        {{ labels('front_messages.update_account_info', 'and update your account information') }}.
                                        {{ labels('front_messages.select_link', 'Select a link below to view or edit information') }}.
                                    </p>
                                </div>
                                ...
                                <div class="account-box">
                                    ...
                                    <div class="box-info mb-4">
                                        ...
                                        <div class="row row-cols-lg-2 row-cols-md-2 row-cols-sm-1 row-cols-1">
                                            <div class="box-content mt-3">
                                                ...
                                                <p class="mb-2">{{ $user_info->role->description }}</p>
                                    ...
                                    <div class="box-info mb-4">
                                        <div class="box-title d-flex-center">
                                            <h4>{{ labels('front_messages.referral_code', 'Referral Code') }}</h4>
                                        </div>
                                        <div class="mb-2 mt-2 d-flex gap-2">
                                            <span>{{ config('app.url') }}register?referral_code={{ $user_info->referral_code }}</span>
                                            <livewire:components.copy-button
                                                text="{{ config('app.url') }}register?referral_code={{ $user_info->referral_code }}" />
                                        </div>
                                    </div>
                                    @if ($user_info->role_id == 8)
                                        <div class="box-info mb-4">
                                            <div class="box-title d-flex-center">
                                                <h4>{{ labels('front_messages.generate_seller_invite_link', 'Generate seller invite link') }}
                                                </h4>
                                            </div>
                                            <div class="mb-2 mt-2 d-flex gap-2">

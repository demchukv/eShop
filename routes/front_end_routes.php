...
Route::middleware(App\Http\Middleware\checkAuth::class)->group(function () {
    ...
    Route::get('/my-account/user-status', UserStatus::class)->name('my-account.user-status');
    Route::post('/my-account/user-status/send_dealer_request', [UserStatus::class, 'send_dealer_request'])->name('my-account.user-status.send_dealer_request');
    Route::post('/my-account/user-status/send_manager_request', [UserStatus::class, 'send_manager_request'])->name('my-account.user-status.send_manager_request');
...
Route::middleware(['guest'])->group(function () {
    ...
    Route::post('/login/telegram-get-user', [Login::class, 'telegram_get_user'])->name('login.telegram_get_user');
    Route::get('/login/telegram-logout', [Login::class, 'telegram_logout'])->name('login.telegram_logout');
    ...
    Route::post('/register/check-telegram', [Register::class, "check_telegram_authorization"])->name('register.check_telegram_authorization');

...
Route::group(
    ...
    function () {
        ...
        Route::prefix('admin')->group(function () {
            ...
            Route::get('categories/category_order', [CategoryController::class, 'categoryOrder'])->name('category_order.index');
            ...
            Route::post("settings/payment_settings", [SettingController::class, 'storePaymentSetting'])->name('payment_setting.store')->middleware('permissions:edit payment_method_setting');

            Route::get("settings/shipping_settings", [SettingController::class, 'shippingSettings'])->name('shipping_settings');

            Route::post("settings/shipping_settings", [SettingController::class, 'storeShippingSettings'])->name('shipping_settings.store')->middleware('permissions:edit shipping_method_setting');
            ...
            Route::post("settings/store_currency_setting", [SettingController::class, 'storeCurrencySetting'])->name('currency_setting.store')->middleware('permissions:edit currency_setting');
            ...
            Route::get('currency/destroy/{id}', [SettingController::class, 'currencyDestroy'])->name('currency.destroy')->middleware('permissions:delete currency_setting');

            Route::get('currency/edit/{id}', [SettingController::class, 'editCurrency'])->name('currency.edit');

            Route::put('currency/update/{id}', [SettingController::class, 'updateCurrency'])->name('currency.update')->middleware('permissions:edit currency_setting');
            ...
            Route::post("settings/pusher_setting", [SettingController::class, 'storePusherSetting'])->name('pusher_setting.store')->middleware('permissions:edit pusher_setting');

            Route::get("settings/s3_storage_setting", [SettingController::class, 's3StorageSetting'])->name('s3StorageSetting');

            Route::post("settings/s3_storage_setting", [SettingController::class, 'store3StorageSetting'])->name('s3StorageSetting.store')->middleware('permissions:edit storage_setting');

            Route::post("settings/notification_settings", [SettingController::class, 'storeNotificationSettings'])->name('notification_settings.store')->middleware('permissions:edit contact_setting');

            Route::post("settings/contact_us", [SettingController::class, 'storeContactUs'])->name('contact_us.store')->middleware('permissions:edit contact_setting');
            ...
            Route::post("/settings/store_sms_data", [SettingController::class, 'store_sms_data'])->name('store_sms_data.store')->middleware('permissions:edit sms_gateway_setting');

            // system policies

            Route::get("settings/system_policies", [SettingController::class, 'systemPolicies'])->name('system_policies');

            Route::post("settings/privacy_policy", [SettingController::class, 'storePrivacyPolicy'])->name('privacy_policy.store')->middleware('permissions:edit system_policies');
            ...
            Route::post("settings/shipping_policy", [SettingController::class, 'storeShippingPolicy'])->name('shipping_policy.store')->middleware('permissions:edit system_policies');

            Route::post("settings/return_policy", [SettingController::class, 'storeReturnPolicy'])->name('return_policy.store')->middleware('permissions:edit system_policies');
            ...
            Route::post("settings/delivery_boy_privacy_policy", [SettingController::class, 'storeDeliveryBoyPrivacyPolicy'])->name('delivery_boy_privacy_policy.store')->middleware('permissions:edit delivery_boy_policies');

            Route::post("settings/delivery_boy_terms_and_conditions", [SettingController::class, 'storeDeliveryBoyTermsAndConditions'])->name('delivery_boy_terms_and_conditions.store')->middleware('permissions:edit delivery_boy_policies');
            ...
            Route::post('brands', [BrandController::class, 'store'])->name('brands.store')->middleware('permissions:create brands');

            Route::get('/brand/update_status/{id}', [BrandController::class, 'update_status'])->middleware('permissions:edit brands');

            Route::get('/brands/list', [BrandController::class, 'list'])->name('brands.list');

            Route::get('brands/destroy/{id}', [BrandController::class, 'destroy'])->name('brands.destroy')->middleware('permissions:delete brands');

            Route::get('brands/bulk_upload', [BrandController::class, 'bulk_upload']);

            Route::post("brands/bulk_upload", [BrandController::class, 'process_bulk_upload'])->name('brands.bulk_upload')->middleware('permissions:create brands');

            Route::get('brands/edit/{id}', [BrandController::class, 'edit'])->name('brands.edit');

            Route::put('brands/update/{id}', [BrandController::class, 'update'])->middleware('permissions:edit brands');
            ...
            Route::get('/tax/update_status/{id}', [TaxController::class, 'update_status'])->middleware('permissions:edit tax');

            Route::post('taxes', [TaxController::class, 'store'])->name('taxes.store')->middleware('permissions:create tax');
            Route::get(
                '/taxes/list',
                [TaxController::class, 'list']
            )->name('taxes.list');

            Route::get('tax/destroy/{id}', [TaxController::class, 'destroy'])->name('taxes.destroy')->middleware('permissions:delete tax');

            Route::get('tax/edit/{id}', [TaxController::class, 'edit'])->name('tax.edit');

            Route::put('tax/update/{id}', [TaxController::class, 'update'])->name('tax.update')->middleware('permissions:edit tax');
            ...
            Route::post('promo_codes', [PromoCodeController::class, 'store'])->name('promo_codes.store')->middleware('permissions:create promo_code');
            Route::get('/promo_code/update_status/{id}', [PromoCodeController::class, 'update_status'])->middleware('permissions:edit promo_code');
            ...
            Route::put('promo_codes/update/{id}', [PromoCodeController::class, 'update'])->name('promo_code.update')->middleware('permissions:edit promo_code');

            Route::get('promo_codes/destroy/{id}', [PromoCodeController::class, 'destroy'])->name('promo_codes.destroy')->middleware('permissions:delete promo_code');
        });
        ...
        Route::post('admin/attributes', [AttributeController::class, 'store'])->name('admin.attributes.store')->middleware('permissions:create attributes');
        Route::get('/attribute/update_status/{id}', [AttributeController::class, 'update_status'])->middleware('permissions:edit attributes');
        Route::post('admin/attribute/getAttributes', [AttributeController::class, 'getAttributes']);

        Route::get('attributes/destroy/{id}', [AttributeController::class, 'destroy'])->name('attributes.destroy')->middleware('permissions:delete attributes');
        ...
        Route::put('admin/products/update/{id}', [ProductController::class, 'update'])->name('admin.products.update')->middleware('permissions:edit product');
        Route::post('admin/products', [ProductController::class, 'store'])->name('admin.products.store')->middleware('permissions:create product');

        Route::get('admin/products/update_status/{id}', [ProductController::class, 'update_status'])->middleware('permissions:edit product');
        ...
        Route::get('admin/products/destroy/{id}', [ProductController::class, 'destroy'])->name('admin.products.destroy')->middleware('permissions:delete product');
        ...
        Route::post("admin/product/bulk_upload", [ProductController::class, 'process_bulk_upload'])->name('admin.product.bulk_upload')->middleware('permissions:create product');

        Route::get("admin/product/change_variant_status", [ProductController::class, 'change_variant_status'])->name('admin.product.change_variant_status')->middleware('permissions:edit product');

        Route::get("admin/product/delete_variant", [ProductController::class, 'delete_variant'])->name('admin.product.delete_variant')->middleware('permissions:delete product');
        ...
        Route::post('admin/sellers', [SellerController::class, 'store'])->name('sellers.store')->middleware('permissions:create seller');

        Route::get('/sellers/list', [SellerController::class, 'list'])->name('sellers.list');

        Route::get('sellers/update_status/{id}', [SellerController::class, 'update_status'])->middleware('permissions:edit seller');

        Route::get('admin/sellers/destroy/{id}', [SellerController::class, 'destroy'])->name('admin.sellers.destroy')->middleware('permissions:delete seller');

        Route::get('admin/sellers/edit/{id}', [SellerController::class, 'edit'])->name('admin.sellers.edit');

        Route::put('admin/sellers/update/{id}', [SellerController::class, 'update'])->name('admin.sellers.update')->middleware('permissions:edit seller');
        ...
        Route::get('admin/pickup_location/update_status/{id}', [PickupLocationController::class, 'update_status'])->middleware('permissions:edit pickup_location');
        Route::put('admin/pickup_location/update/{id}', [PickupLocationController::class, 'update'])->name('admin.pickup_location.update')->middleware('permissions:edit pickup_location');

        Route::get('admin/pickup_location/destroy/{id}', [PickupLocationController::class, 'destroy'])->name('admin.pickup_location.destroy')->middleware('permissions:delete pickup_location');
        ...
        Route::post('admin/orders/update_order_status', [OrderController::class, 'update_order_status'])->middleware('permissions:edit orders');
        Route::post('admin/orders/update_order_tracking', [OrderController::class, 'update_order_tracking'])->name('admin.orders.update_order_tracking')->middleware('permissions:edit orders');
        Route::post('admin/orders/create_shiprocket_order', [OrderController::class, 'create_shiprocket_order'])->name('admin.orders.create_shiprocket_order')->middleware('permissions:edit orders');
        Route::post('admin/orders/generate_awb', [OrderController::class, 'generate_awb'])->name('admin.orders.generate_awb')->middleware('permissions:edit orders');
        Route::post('admin/orders/send_pickup_request', [OrderController::class, 'send_pickup_request'])->name('admin.orders.send_pickup_request')->middleware('permissions:edit orders');
        Route::post('admin/orders/cancel_shiprocket_order', [OrderController::class, 'cancel_shiprocket_order'])->name('admin.orders.cancel_shiprocket_order')->middleware('permissions:edit orders');
        Route::post('admin/orders/generate_label', [OrderController::class, 'generate_label'])->name('admin.orders.generate_label')->middleware('permissions:edit orders');
        Route::post('admin/orders/generate_invoice', [OrderController::class, 'generate_invoice'])->name('admin.orders.generate_invoice')->middleware('permissions:edit orders');
        ...
        Route::get('admin/order_items/destroy/{id}', [OrderController::class, 'order_item_destroy'])->name('admin.order.items.destroy')->middleware('permissions:delete orders');

        Route::get('admin/order/destroy/{id}', [OrderController::class, 'destroy'])->name('admin.orders.destroy')->middleware('permissions:delete orders');

        Route::post('admin/orders/send_digital_product', [OrderController::class, 'send_digital_product'])->name('admin.orders.send_digital_product')->middleware('permissions:edit orders');
        ...
        Route::get('admin/orders/delete_receipt/{id}', [OrderController::class, 'destroyReceipt'])->name('admin.orders.delete_receipt')->middleware('permissions:edit orders');

        Route::post('admin/orders/update_receipt_status', [OrderController::class, 'update_receipt_status'])->name('admin.orders.update_receipt_status')->middleware('permissions:edit orders');
        ...
        Route::post('admin/return_request/update', [ReturnRequestController::class, 'update'])->name('admin.return_request.update');
        ...
        Route::put('admin/manage_stock/update/{id}', [ManageStockController::class, 'update'])->name('admin.stock.update')->middleware('permissions:edit stock');
        ...
        Route::get('admin/manage_combo_stock', [ManageStockController::class, 'manage_combo_stock'])->name('admin.manage_combo_stock.index');

        Route::put('admin/manage_combo_stock/update/{id}', [ManageStockController::class, 'combo_stock_update'])->name('admin.combo_stock.update')->middleware('permissions:edit combo_stock');
        ...
        Route::post('admin/payment_request/update', [PaymentRequestController::class, 'update'])->name('admin.payment_request.update')->middleware('permissions:edit payment_request');
        ...
        Route::post('admin/sliders', [SliderController::class, 'store'])->name('sliders.store')->middleware('permissions:create slider_images');
        Route::put('admin/sliders/update/{id}', [SliderController::class, 'update'])->name('sliders.update')->middleware('permissions:edit slider_images');
        Route::get(
            '/sliders/list',
            [SliderController::class, 'list']
        )->name('sliders.list');

        Route::get('sliders/destroy/{id}', [SliderController::class, 'destroy'])->name('sliders.destroy')->middleware('permissions:delete slider_images');
        ...
        Route::put('admin/offers/update/{id}', [OfferController::class, 'update'])->name('offers.update')->middleware('permissions:edit offer_images');
        Route::get(
            '/offers/list',
            [OfferController::class, 'list']
        )->name('offers.list');
        Route::post('admin/offers', [OfferController::class, 'store'])->name('offers.store')->middleware('permissions:create offer_images');
        Route::get('offers/destroy/{id}', [OfferController::class, 'destroy'])->name('offers.destroy')->middleware('permissions:delete offer_images');
        ...
        Route::post('admin/product_faqs', [ProductFaqController::class, 'store'])->name('product_faqs.store')->middleware('permissions:create product_faq');
        Route::get('admin/product_faqs/list', [ProductFaqController::class, 'list'])->name('admin.product_faqs.list');


        Route::get('admin/product_faqs/destroy/{id}', [ProductFaqController::class, 'destroy'])->name('admin.product_faqs.destroy')->middleware('permissions:delete product_faq');
        Route::get('admin/product_faqs/edit/{id}', [ProductFaqController::class, 'edit']);
        Route::put('admin/product_faqs/update/{id}', [ProductFaqController::class, 'update'])->middleware('permissions:edit product_faq');
        ...
        Route::post('admin/combo_product_faqs', [ComboProductFaqController::class, 'store'])->name('combo_product_faqs.store')->middleware('permissions:create combo_product_faq');
        Route::get('admin/combo_product_faqs/list', [ComboProductFaqController::class, 'list'])->name('admin.combo_product_faqs.list');
        Route::get('admin/combo_product_faqs/destroy/{id}', [ComboProductFaqController::class, 'destroy'])->name('admin.combo_product_faqs.destroy')->middleware('permissions:delete combo_product_faq');
        Route::get('admin/combo_product_faqs/edit/{id}', [ComboProductFaqController::class, 'edit']);
        Route::put('admin/combo_product_faqs/update/{id}', [ComboProductFaqController::class, 'update'])->middleware('permissions:edit combo_product_faq');



        // media

        Route::post('/admin/media/upload', [MediaController::class, 'upload'])->name('admin.media.upload')->middleware('permissions:create media');

        Route::get('/admin/media', [MediaController::class, 'index'])->name('admin.media');

        Route::get('/admin/media/destroy/{id}', [MediaController::class, 'destroy'])->name('admin.media.destroy')->middleware('permissions:delete media');

        Route::get('/admin/storage_type', [MediaController::class, 'storage_type'])->name('admin.storage_type');

        Route::post("admin/media/storage_type", [MediaController::class, 'store_storage_type'])->name('admin.storage_type.store')->middleware('permissions:create storage_type');

        Route::get('/admin/storage_type/destroy/{id}', [MediaController::class, 'storage_type_destroy'])->name('admin.storage_type.destroy')->middleware('permissions:delete storage_type');
        ...
        Route::put('admin/storage_type/update/{id}', [MediaController::class, 'storage_type_update'])->name('admin.storage_type.update')->middleware('permissions:edit storage_type');

        Route::get('admin/storage_type/set_default/{id}', [MediaController::class, 'set_default_storage_type'])->middleware('permissions:edit storage_type');
        ...
        Route::post("admin/delivery_boys", [Delivery_boyController::class, 'store'])->name('delivery_boys.store')->middleware('permissions:create delivery_boy');

        Route::put('/admin/delivery_boys/update/{id}', [Delivery_boyController::class, 'update'])->name('admin.delivery_boys.update')->middleware('permissions:edit delivery_boy');

        Route::get('/delivery_boys/list', [Delivery_boyController::class, 'list'])->name('delivery_boys.list');

        Route::get('delivery_boys/destroy/{id}', [Delivery_boyController::class, 'destroy'])->name('delivery_boys.destroy')->middleware('permissions:delete delivery_boy');

        Route::get('admin/delivery_boy/update_status/{id}', [Delivery_boyController::class, 'update_status'])->middleware('permissions:edit delivery_boy');

        // zipcodes

        Route::get("admin/area/zipcodes", [AreaController::class, 'displayZipcodes'])->name('admin.display_zipcodes');

        Route::post("admin/area/store_zipcodes", [AreaController::class, 'storeZipcodes'])->name('admin.zipcodes.store')->middleware('permissions:create zipcodes');
        ...
        Route::get('zipcodes/destroy/{id}', [AreaController::class, 'distroyZipcode'])->name('admin.zipcodes.destroy')->middleware('permissions:delete zipcodes');
        ...
        Route::put('admin/zipcodes/update/{id}', [AreaController::class, 'zipcodesUpdate'])->name('admin.zipcodes.update')->middleware('permissions:edit zipcodes');
        ...
        Route::post("admin/area/location_bulk_upload", [AreaController::class, 'process_bulk_upload'])->name('location.bulk_upload');
        ...
        Route::get('notification/destroy/{id}', [NotificationController::class, 'destroy'])->name('admin.notification.destroy')->middleware('permissions:delete send_notification');
        ...
        Route::resource("admin/user_status", UserStatusController::class)->names([
            'index' => 'admin.user_status.index',
        ])->only(['index']);
        Route::put('admin/user_status/update', [UserStatusController::class, 'update'])->name('admin.user_status.update');
        Route::get('admin/user_status/list', [UserStatusController::class, 'list'])->name('admin.user_status.list');
        ...
        Route::post('admin/custom_message', [CustomMessageController::class, 'store'])->name('custom_message.store')->middleware('permissions:create custom_message');
        ...
        Route::put('admin/custom_message/update/{id}', [CustomMessageController::class, 'update'])->name('custom_message.update')->middleware('permissions:edit custom_message');

        Route::get('admin/custom_message/{id}', [CustomMessageController::class, 'destroy'])->name('custom_message.destroy')->middleware('permissions:delete custom_message');
        ...
        Route::post('/admin/customers/edit_transactions', [TransactionController::class, 'edit_transactions'])->name('admin.customers.edit_transactions')->middleware('permissions:edit customers');
        ...
        Route::post('/admin/customers/updateCustomerWallet', [UserController::class, 'updateCustomerWallet'])->name('admin.customers.updateCustomerWallet')->middleware('permissions:edit customer_wallet_transaction');

        Route::get('/admin/customers/update_status/{id}', [UserController::class, 'update_status'])->middleware('permissions:edit customers');


        Route::get('admin/customers/{id}', [UserController::class, 'destroy'])->name('customers.destroy')->middleware('permissions:delete customers');
        ...
        Route::get('admin/store/set_default_store/{id}', [StoreController::class, 'set_default_store'])->middleware('permissions:edit store');

        Route::put('/admin/store/update/{id}', [StoreController::class, 'update'])->middleware('permissions:edit store');
        ...
        Route::post("offers/offer_sliders", [OfferController::class, 'store_offer_slider'])->name('offer_sliders.store')->middleware('permissions:create offer_slider');

        Route::get('admin/offer_sliders', [OfferController::class, 'offer_slider'])->name('offer_sliders.index');
        ...
        Route::get('offer_sliders/destroy/{id}', [OfferController::class, 'offer_slider_destroy'])->name('admin.offer_slider.destroy')->middleware('permissions:delete offer_slider');

        Route::get('admin/offer_sliders/update_status/{id}', [OfferController::class, 'update_offer_slider_status'])->middleware('permissions:edit offer_slider');

        Route::get('offer_sliders/edit/{id}', [OfferController::class, 'offer_slider_edit'])->name('admin.offer_sliders.update');

        Route::put('admin/offer_sliders/update/{id}', [OfferController::class, 'offer_slider_update'])->middleware('permissions:edit offer_slider');
        ...
        Route::post('admin/combo_product_attributes', [ComboProductAttributeController::class, 'store'])->name('admin.combo_product_attributes.store')->middleware('permissions:create combo_attributes');
        ...
        Route::get('admin/combo_product_attributes/update_status/{id}', [ComboProductAttributeController::class, 'update_status'])->middleware('permissions:edit combo_attributes');

        Route::post('admin/combo_product_attributes/getAttributes', [ComboProductAttributeController::class, 'getAttributes']);

        Route::get('combo_product_attributes/destroy/{id}', [ComboProductAttributeController::class, 'destroy'])->name('admin.combo_product_attributes.destroy')->middleware('permissions:delete combo_attributes');

        Route::put('/admin/combo_product_attributes/update/{id}', [ComboProductAttributeController::class, 'update'])->middleware('permissions:edit combo_attributes');
        ...
        Route::get('admin/combo_products/destroy/{id}', [ComboProductController::class, 'destroy'])->name('admin.combo_products.destroy')->middleware('permissions:delete combo_product');

        Route::post("admin/combo_products/store", [ComboProductController::class, 'store'])->name('admin.combo_products.store')->middleware('permissions:create combo_product');
        ...
        Route::put('admin/combo_products/update/{id}', [ComboProductController::class, 'update'])->middleware('permissions:edit combo_product')->name('admin.combo_products.update');
        ...
        Route::get('admin/combo_products/update_status/{id}', [ComboProductController::class, 'update_status'])->middleware('permissions:edit combo_product');
        ...
        Route::post("admin/combo_product/bulk_upload", [ComboProductController::class, 'process_bulk_upload'])->name('admin.combo.product.process_bulk_upload')->middleware('permissions:create combo_product');
        ...
        Route::post("admin/delivery_boys/manage_cash_collection", [Delivery_boyController::class, 'manage_cash_collection'])->name('admin.manage_cash_collection')->middleware('permissions:edit delivery_boy_cash_collection');

        //fund transfer

        Route::post('admin/fund_transfer/add_fund_transfer', [FundTransferController::class, 'store'])->name('admin.add_fund_transfer')->middleware('permissions:create delivery_boy');
        ...
        Route::post('admin/settings/language', [LanguageController::class, 'store'])->name('language.store');

        Route::put("admin/settings/languages/savelabel", [LanguageController::class, 'savelabel'])->name('savelabel');
        ...
        Route::post('admin/web_settings/language', [FrontLanguageController::class, 'store'])->name('web_language.store');

        Route::put("admin/web_settings/languages/savelabel", [FrontLanguageController::class, 'savelabel'])->name('savelabel');
        ...
        Route::delete('/brands/delete', [BrandController::class, 'delete_selected_data'])->name('brands.delete');

        Route::delete('/sellers/delete', [SellerController::class, 'delete_selected_data'])->name('sellers.delete');

        Route::delete('/taxes/delete', [TaxController::class, 'delete_selected_data'])->name('taxes.delete');

        Route::delete('/products/delete', [ProductController::class, 'delete_selected_data'])->name('products.delete');

        Route::delete('/faqs/delete', [ProductFaqController::class, 'delete_selected_data'])->name('faqs.delete');

        Route::delete('/combo_products/delete', [ComboProductController::class, 'delete_selected_data'])->name('combo_products.delete');

        Route::delete('/combo_faqs/delete', [ComboProductFaqController::class, 'delete_selected_data'])->name('combo_faqs.delete');
        ...
        Route::delete('/sliders/delete', [SliderController::class, 'delete_selected_data'])->name('sliders.delete');

        Route::delete('/offers/delete', [OfferController::class, 'delete_selected_data'])->name('offers.delete');

        Route::delete('/offer_sliders/delete', [OfferController::class, 'delete_selected_slider_data'])->name('offer_sliders.delete');

        Route::delete('/promo_codes/delete', [PromoCodeController::class, 'delete_selected_data'])->name('promo_codes.delete');
        ...
        Route::delete('/delivery_boys/delete', [Delivery_boyController::class, 'delete_selected_data'])->name('delivery_boys.delete');
        ...
        Route::delete('/custom_messages/delete', [CustomMessageController::class, 'delete_selected_data'])->name('custom_messages.delete');

        Route::delete('/zipcodes/delete', [AreaController::class, 'delete_selected_data'])->name('zipcodes.delete');
        ...
        Route::post('admin/zones', [ZoneController::class, 'store'])->name('admin.zones.store')->middleware('permissions:create zones');
        Route::put('admin/zones/update/{id}', [ZoneController::class, 'update'])->name('zones.update')->middleware('permissions:edit zones');
        Route::get(
            '/zones/list',
            [ZoneController::class, 'list']
        )->name('admin.zones.list')->middleware('permissions:view zones');
        Route::get('admin/zones/update_status/{id}', [ZoneController::class, 'update_status'])->middleware('permissions:edit zones');
        Route::get('zones/destroy/{id}', [ZoneController::class, 'destroy'])->name('admin.zones.destroy')->middleware('permissions:delete zones');
        Route::delete('/zones/delete', [ZoneController::class, 'delete_selected_data'])->name('zones.delete');
        ...
        Route::get('admin/disputs/{id}', [App\Http\Controllers\Admin\AdminDisputController::class, 'show'])->name('admin.disput.show');

...
Route::group(['middleware' => ['check_token', 'auth:sanctum']], function () {
    Route::get('get_delivery_boy_details', [ApiController::class, 'get_delivery_boy_details']);
    ...
    Route::post('update_user', [ApiController::class, 'update_user']); // use POST method instead of PUT because we need to send file in this API
    ...
    Route::get('get_returned_order_items', [ApiController::class, 'get_returned_order_items']);

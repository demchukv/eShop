...
Route::get('get_taxes', [ApiController::class, 'get_taxes']);
Route::get('get_countries_data', [ApiController::class, 'get_countries_data']);
Route::get('get_brand_list', [ApiController::class, 'get_brand_list']);
...
Route::group(['middleware' => ['check_token', 'auth:sanctum']], function () {
    ...
    Route::get('get_order_items', [ApiController::class, 'get_order_items']);
    ...
    Route::get('get_statistics', [ApiController::class, 'get_statistics']);
    ...
    Route::post('add_products', [ApiController::class, 'add_products']);
    Route::get('get_seller_details', [ApiController::class, 'get_seller_details']);
    Route::delete('delete_product', [ApiController::class, 'delete_product']);
    Route::put('update_products', [ApiController::class, 'update_products']);
    ...
    Route::get('get_seller_stores', [ApiController::class, 'get_seller_stores']);
    Route::get('get_combo_products', [ApiController::class, 'get_combo_products']);
    Route::post('add_combo_product', [ApiController::class, 'add_combo_product']);
    Route::delete('delete_combo_product', [ApiController::class, 'delete_combo_product']);
    Route::put('update_combo_product', [ApiController::class, 'update_combo_product']);
    Route::post('add_seller_store', [ApiController::class, 'add_seller_store']);
    ...
    Route::get('most_selling_categories', [ApiController::class, 'most_selling_categories']);
    Route::get('top_selling_products', [ApiController::class, 'top_selling_products']);

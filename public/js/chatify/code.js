 ...
 *-------------------------------------------------------------
 */
Pusher.logToConsole = false; //chatify.pusher.debug;
...
const channelName = chatify.pusher.channel_name;
...
if (channel) {
    channel.bind("messaging", function (data) {
        if (data.from_id == getMessengerId() && data.to_id == auth_id) {
            ...
            messagesContainer.find(".messages").append(data.formatted_message);
            scrollToBottom(messagesContainer);
            makeSeen(true);

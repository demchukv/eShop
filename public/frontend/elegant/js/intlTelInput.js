    ...
    Plugin.prototype = {
        ...
        _filterCountries: function (countryArray, processFunc) {
            ...
            for (i = 0; i < allCountries.length; i++) {
                if (
                    processFunc($.inArray(allCountries[i].iso2, countryArray))
                ) {
            ...
            if ($.fn[pluginName].autoCountry) {
                ...
                if (typeof this.options.geoIpLookup === "function") {
                    this.options.geoIpLookup(function (countryCode) {
                        ...
                        setTimeout(function () {
                            $(".intl-tel-input input").intlTelInput(
                                "handleAutoCountry"
                            );
                        });
                    });
        ...
        _setDropdownPosition: function () {
            ...
            if (!this.isMobile) {
                var pos = this.telInput.offset(),
                    ...
                    dropdownFitsBelow =
                        inputTop +
                            this.telInput.outerHeight() +
                            this.dropdownHeight <
                        windowTop + $(window).height(),
                    dropdownFitsAbove =
                        inputTop - this.dropdownHeight > windowTop;
        ...
        _updateFlagFromNumber: function (number, isInit) {
            ...
            if (dialCode) {
                ...
                number.charAt(0) == "+" &&
                this._getNumeric(number).length
            ) {
        ...
        _setFlag: function (countryCode, isInit) {
            ...
            if (this.options.separateDialCode) {
                ...
                if (prevCountry.dialCode) {
                    parent.removeClass(
                        "iti-sdc-" + (prevCountry.dialCode.length + 1)
                    );
                }
        ...
        _updatePlaceholder: function () {
            if (
                ...
                var numberType =
                        intlTelInputUtils.numberType[this.options.numberType],
